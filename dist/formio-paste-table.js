import { Components as e } from "formiojs";
...
var a, o = class {
	...
	containerEventCoords(e) {
		...
		if (this.container !== document.body) {
			let e = s.elOffset(this.container);
			n -= e.left, r -= e.top;
		}
		return {
			x: n,
	...
	elementPositionCoords(e, t = "right") {
		var n = s.elOffset(e), r, i, a;
		switch (this.container !== document.body && (r = s.elOffset(this.container), n.left -= r.left, n.top -= r.top), t) {
			case "right":
	...
	transformRow(e, t) {
		var n = "accessor" + (t.charAt(0).toUpperCase() + t.slice(1)), r = e.getComponent(), i = s.deepClone(e.data || {});
...
i(d, "moduleName", "accessor"), i(d, "accessors", u);
var f = { method: "GET" };
function p(e, t) {
	var n = [];
	if (t = t || "", Array.isArray(e)) e.forEach((e, r) => {
		n = n.concat(p(e, t ? t + "[" + r + "]" : r));
	});
	else if (typeof e == "object") for (var r in e) n = n.concat(p(e[r], t ? t + "[" + r + "]" : r));
	else n.push({
		key: t,
		value: e
	});
...
function h(e, t, n) {
	return e && n && Object.keys(n).length && (!t.method || t.method.toLowerCase() == "get") && (t.method = "get", e += (e.includes("?") ? "&" : "?") + m(n)), e;
}
function g(e, t, n) {
	var r;
...
function _(e, t) {
	var n = [];
	if (t = t || "", Array.isArray(e)) e.forEach((e, r) => {
		n = n.concat(_(e, t ? t + "[" + r + "]" : r));
	});
	else if (typeof e == "object") for (var r in e) n = n.concat(_(e[r], t ? t + "[" + r + "]" : r));
	else n.push({
		key: t,
		value: e
	});
...
i(y, "moduleName", "ajax"), i(y, "defaultConfig", f), i(y, "defaultURLGenerator", h), i(y, "defaultLoaderPromise", g), i(y, "contentTypeFormatters", v);
var b = {
	replace: function(e) {
...
i(C, "moduleName", "clipboard"), i(C, "moduleExtensions", S), i(C, "pasteActions", b), i(C, "pasteParsers", x);
var ee = class {
	constructor(e) {
	...
	_getNestedData(e) {
		var t = e, n = this.fieldStructure, r = n.length, i;
		for (let e = 0; e < r && (t = t[n[e]], i = t, t); e++);
		return i;
	}
	_setFlatData(e, t) {
	...
	_setNestedData(e, t) {
		var n = e, r = this.fieldStructure, i = r.length;
		for (let e = 0; e < i; e++) if (e == i - 1) n[r[e]] = t;
		else {
			if (!n[r[e]]) if (t !== void 0) n[r[e]] = {};
			else break;
			n = n[r[e]];
		}
	}
	...
	checkCellHeights() {
		...
		this.cells.forEach(function(t) {
			t.row.heightInitialized && (t.row.getElement().offsetParent === null ? t.row.heightInitialized = !1 : (e.push(t.row), t.row.clearCellHeight()));
		}), e.forEach(function(e) {
			e.calcHeight();
		}), e.forEach(function(e) {
			e.setCellHeight();
	...
	delete() {
		return new Promise((e, t) => {
			...
			for (let e = 0; e < n; e++) this.cells[0].delete();
	...
	reinitializeWidth(e) {
		this.widthFixed = !1, this.definition.width !== void 0 && !e && this.setWidth(this.definition.width), this.dispatch("column-width-fit-before", this), this.fitToData(e), this.dispatch("column-width-fit-after", this);
	}
	fitToData(e) {
		if (!this.isGroup) {
			...
			if ((!this.width || !this.widthFixed) && (this.cells.forEach((e) => {
				...
				var n = t + 1;
				e ? this.setWidth(n) : (this.maxInitialWidth && !e && (n = Math.min(n, this.maxInitialWidth)), this.setWidthActual(n));
			}
		}
	}
	updateDefinition(e) {
...
var E = class {
	...
	constructor(e, t, n = "row") {
		super(t.table), this.parent = t, this.data = {}, this.type = n, this.element = !1, this.modules = {}, this.cells = [], this.height = 0, this.heightStyled = "", this.manualHeight = !1, this.outerHeight = 0, this.initialized = !1, this.heightInitialized = !1, this.position = 0, this.positionWatchers = [], this.component = null, this.created = !1, this.setData(e);
	}
	create() {
	...
	updateData(e) {
		var t = this.element && s.elVisible(this.element), n = {}, r;
		return new Promise((i, a) => {
			typeof e == "string" && (e = JSON.parse(e)), this.dispatch("row-data-save-before", this), this.subscribed("row-data-changing") && (n = Object.assign(n, this.data), n = Object.assign(n, e)), r = this.chain("row-data-changing", [
				this,
				n,
				e
			], null, e);
			let o = [];
			for (let t in e) this.table.columnManager.getColumnsByFieldRoot(t).forEach((e) => {
				let t = this.getCell(e.getField());
				if (t) {
					let n = e.getFieldValue(r);
					t.getValue() !== n && o.push([t, n]);
				}
			});
			for (let e in r) this.data[e] = r[e];
			this.dispatch("row-data-save-after", this), o.forEach(([e, n]) => {
				e.setValueProcessData(n), t && e.cellRendered();
			}), t ? (this.normalizeHeight(!0), this.table.options.rowFormatter && this.table.options.rowFormatter(this.getComponent())) : (this.initialized = !1, this.height = 0, this.heightStyled = ""), this.dispatch("row-data-changed", this, t, e), this.dispatchExternal("rowUpdated", this.getComponent()), this.subscribedExternal("dataChanged") && this.dispatchExternal("dataChanged", this.table.rowManager.getData()), i();
		});
	}
	getData(e) {
	...
	sum: function(e, t, n) {
		var r = 0, i = n.precision === void 0 ? !1 : n.precision;
	...
	unique: function(e, t, n) {
		return e.filter((t, n) => (e || t === 0) && e.indexOf(t) === n).length;
	}
}, O = class e extends l {
	constructor(e) {
	...
	recalcAll() {
		(this.topCalcs.length || this.botCalcs.length) && (this.table.options.columnCalcs !== "group" && this.recalcActiveRows(), this.table.options.groupBy && this.table.options.columnCalcs !== "table" && this.table.modules.groupRows.getChildGroups().forEach((e) => {
			this.recalcGroup(e);
		}));
	}
	recalcGroup(e) {
		var t, n;
		this.blockCheck() || e && e.calcs && (e.calcs.bottom && (t = this.rowsToData(e.rows), n = this.generateRowData("bottom", t), e.calcs.bottom.updateData(n), e.calcs.bottom.reinitialize()), e.calcs.top && (t = this.rowsToData(e.rows), n = this.generateRowData("top", t), e.calcs.top.updateData(n), e.calcs.top.reinitialize()));
	}
	generateTopRow(e) {
	...
	rowsToData(e) {
		var t = [], n = this.table.options.dataTree && this.table.options.dataTreeChildColumnCalcs, r = this.table.modules.dataTree;
		return e.forEach((e) => {
			var i;
			t.push(e.getData()), n && (i = e.modules.dataTree) != null && i.open && this.rowsToData(r.getFilteredTreeChildren(e)).forEach((n) => {
				t.push(e);
			});
		}), t;
	}
	generateRow(e, t) {
		var n = this.generateRowData(e, t), r;
		return this.table.modExists("mutator") && this.table.modules.mutator.disable(), r = new D(n, this, "calc"), this.table.modExists("mutator") && this.table.modules.mutator.enable(), r.getElement().classList.add("tabulator-calcs", "tabulator-calcs-" + e), r.component = !1, r.getComponent = () => (r.component || (r.component = new ee(r)), r.component), r.generateCells = () => {
			var t = [];
			this.table.columnManager.columnsByIndex.forEach((n) => {
				...
				var i = new w(this.genColumn, r);
				i.getElement(), i.column = n, i.setWidth(), n.cells.push(i), t.push(i), n.visible || i.hide();
			}), r.cells = t;
		}, r;
	}
	generateRowData(e, t) {
		var n = {}, r = e == "top" ? this.topCalcs : this.botCalcs, i = e == "top" ? "topCalc" : "botCalc", a, o;
		return r.forEach(function(e) {
			var r = [];
			e.modules.columnCalcs && e.modules.columnCalcs[i] && (t.forEach(function(t) {
				r.push(e.getFieldValue(t));
			}), o = i + "Params", a = typeof e.modules.columnCalcs[o] == "function" ? e.modules.columnCalcs[o](r, t) : e.modules.columnCalcs[o], e.setFieldValue(n, e.modules.columnCalcs[i](r, t, a)));
		}), n;
	}
	hasTopCalcs() {
	...
	getResults() {
		var e = {}, t;
		return this.table.options.groupBy && this.table.modExists("groupRows") ? (t = this.table.modules.groupRows.getGroups(!0), t.forEach((t) => {
	...
	getGroupResults(e) {
		var t = e._getSelf(), n = e.getSubGroups(), r = {}, i = {};
		return n.forEach((e) => {
			r[e.getKey()] = this.getGroupResults(e);
		}), i = {
...
i(O, "moduleName", "columnCalcs"), i(O, "calculations", ie);
var ae = class extends l {
	...
	tableRedrawing(e) {
		var t;
		e && (t = this.table.rowManager.getRows(), t.forEach((e) => {
	...
	initializeRow(e) {
		var t = e.getData()[this.field], n = Array.isArray(t), r = n || !n && typeof t == "object" && !!t;
	...
	layoutRow(e) {
		var t = (this.elementField ? e.getCell(this.elementField) : e.getCells()[0]).getElement(), n = e.modules.dataTree;
	...
	generateControlElement(e, t) {
		var n = e.modules.dataTree, r = n.controlEl;
		t = t || e.getCells()[0].getElement(), n.children !== !1 && (n.open ? (n.controlEl = this.collapseEl.cloneNode(!0), n.controlEl.addEventListener("click", (t) => {
			t.stopPropagation(), this.collapseRow(e);
		})) : (n.controlEl = this.expandEl.cloneNode(!0), n.controlEl.addEventListener("click", (t) => {
			t.stopPropagation(), this.expandRow(e);
		})), n.controlEl.addEventListener("mousedown", (e) => {
			e.stopPropagation();
	...
	getRows(e) {
		...
		return e.forEach((e, n) => {
			var r, i;
			t.push(e), e instanceof D && (e.create(), r = e.modules.dataTree, !r.index && r.children !== !1 && (i = this.getChildren(e, !1, !0), i.forEach((e) => {
				e.create(), t.push(e);
			})));
		}), t;
	}
	getChildren(e, t, n) {
		var r = e.modules.dataTree, i = [], a = [];
		return r.children !== !1 && (r.open || t) && (Array.isArray(r.children) || (r.children = this.generateChildren(e)), i = this.table.modExists("filter") && this.table.options.dataTreeFilter ? this.table.modules.filter.filter(r.children) : r.children, this.table.modExists("sort") && this.table.options.dataTreeSort && this.table.modules.sort.sort(i, n), i.forEach((e) => {
			a.push(e), this.getChildren(e, !1, !0).forEach((e) => {
				a.push(e);
			});
		})), a;
	}
	generateChildren(e) {
		var t = [], n = e.getData()[this.field];
		return Array.isArray(n) || (n = [n]), n.forEach((n) => {
			var r = new D(n || {}, this.table.rowManager);
			r.create(), r.modules.dataTree.index = e.modules.dataTree.index + 1, r.modules.dataTree.parent = e, r.modules.dataTree.children && (r.modules.dataTree.open = this.startOpen(r.getComponent(), r.modules.dataTree.index)), t.push(r);
		}), t;
	}
	expandRow(e, t) {
	...
	getFilteredTreeChildren(e) {
		var t = e.modules.dataTree, n = [], r;
		return t.children && (Array.isArray(t.children) || (t.children = this.generateChildren(e)), r = this.table.modExists("filter") && this.table.options.dataTreeFilter ? this.table.modules.filter.filter(t.children) : t.children, r.forEach((e) => {
			e instanceof D && n.push(e);
		})), n;
	}
	rowDeleting(e) {
		var t = e.modules.dataTree;
		t && t.children && Array.isArray(t.children) && t.children.forEach((e) => {
			e instanceof D && e.wipe();
		});
	}
	rowDelete(e) {
		var t = e.modules.dataTree.parent, n;
	...
	addTreeChildRow(e, t, n, r) {
		var i = !1;
		typeof t == "string" && (t = JSON.parse(t)), Array.isArray(e.data[this.field]) || (e.data[this.field] = [], e.modules.dataTree.open = this.startOpen(e.getComponent(), e.modules.dataTree.index)), r !== void 0 && (i = this.findChildIndex(r, e), i !== !1 && e.data[this.field].splice(n ? i : i + 1, 0, t)), i === !1 && (n ? e.data[this.field].unshift(t) : e.data[this.field].push(t)), this.initializeRow(e), this.layoutRow(e), this.refreshData(!0);
	}
	findChildIndex(e, t) {
		var n = !1;
		return typeof e == "object" ? e instanceof D ? n = e.data : e instanceof E ? n = e._getSelf().data : typeof HTMLElement < "u" && e instanceof HTMLElement ? t.modules.dataTree && (n = t.modules.dataTree.children.find((t) => t instanceof D ? t.element === e : !1), n && (n = n.data)) : e === null && (n = !1) : n = e === void 0 ? !1 : t.data[this.field].find((t) => t.data[this.table.options.index] == e), n && (Array.isArray(t.data[this.field]) && (n = t.data[this.field].indexOf(n)), n == -1 && (n = !1)), n;
	}
	getTreeChildren(e, t, n) {
		var r = e.modules.dataTree, i = [];
		return r && r.children && (Array.isArray(r.children) || (r.children = this.generateChildren(e)), r.children.forEach((e) => {
			e instanceof D && (i.push(t ? e.getComponent() : e), n && this.getTreeChildren(e, t, n).forEach((e) => {
				i.push(e);
			}));
		})), i;
	}
...
i(ae, "moduleName", "dataTree");
function oe(e, t = {}, n) {
	var r = t.delimiter ? t.delimiter : ",", i = [], a = [];
	e.forEach((e) => {
		var t = [];
		switch (e.type) {
			case "group":
...
function ce(e, t = {}, n) {
	var r = [], i = [], a = {}, o = t.rowGroupStyles || {
		...
		cellPadding: 4,
		fillColor: 232
	}, c = t.jsPDF || {}, l = t.title ? t.title : "", u, d;
	c.orientation || (c.orientation = t.orientation || "landscape"), c.unit || (c.unit = "pt"), e.forEach((e) => {
		switch (e.type) {
			case "header":
				r.push(f(e));
				break;
	...
	u = this.dependencyRegistry.lookup("jspdf", "jsPDF"), d = new u(c), t.autoTable && (a = typeof t.autoTable == "function" ? t.autoTable(d) || {} : t.autoTable), l && (a.didDrawPage = function(e) {
		d.text(l, 40, 30);
	}), a.head = r, a.body = i, d.autoTable(a), t.documentProcessing && t.documentProcessing(d), n(d.output("arraybuffer"), "application/pdf");
}
function le(e, t, n) {
	var r = this, i = t.sheetName || "Sheet1", a = this.dependencyRegistry.lookup("XLSX"), s = a.utils.book_new(), c = new o(this), l = "compress" in t ? t.compress : !0, u = t.writeOptions || {
		bookType: "xlsx",
		bookSST: !0,
		compression: l
	}, d;
	u.type = "binary", s.SheetNames = [], s.Sheets = {};
	function f() {
		var t = [], n = [], r = {}, i = {
			s: {
				c: 0,
		...
		return e.forEach((e, r) => {
			...
			e.columns.forEach(function(e, t) {
				e ? (i.push(!(e.value instanceof Date) && typeof e.value == "object" ? JSON.stringify(e.value) : e.value), (e.width > 1 || e.height > -1) && (e.height > 1 || e.width > 1) && n.push({
					s: {
						r,
						c: t
					},
	...
	if (t.sheets) for (var p in t.sheets) t.sheets[p] === !0 ? (s.SheetNames.push(p), s.Sheets[p] = f()) : (s.SheetNames.push(p), c.commsSend(t.sheets[p], "download", "intercept", {
		type: "xlsx",
		options: { sheetOnly: !0 },
		active: r.active,
	...
	else s.SheetNames.push(i), s.Sheets[i] = f();
	t.documentProcessing && (s = t.documentProcessing(s));
	function m(e) {
		for (var t = new ArrayBuffer(e.length), n = new Uint8Array(t), r = 0; r != e.length; ++r) n[r] = e.charCodeAt(r) & 255;
		return t;
	}
	d = a.write(s, u), n(m(d), "application/octet-stream");
}
function ue(e, t, n) {
...
var fe = {
	...
	downloadToTab(e, t, n, r) {
		this.download(e, t, n, r, !0);
	}
	download(t, n, r, i, a) {
		var o = !1;
		function s(e, r) {
		...
		if (typeof t == "function" ? o = t : e.downloaders[t] ? o = e.downloaders[t] : console.warn("Download Error - No such download type found: ", t), o) {
			var c = this.generateExportList(i);
			o.call(this.table, c, r || {}, s.bind(this));
		}
	}
	generateExportList(e) {
		var t = this.table.modules.export.generateExportList(this.table.options.downloadConfig, !1, e || this.table.options.downloadRowRange, "download"), n = this.table.options.groupHeaderDownload;
		return n && !Array.isArray(n) && (n = [n]), t.forEach((e) => {
			var t;
			e.type === "group" && (t = e.columns[0], n && n[e.indent] && (t.value = n[e.indent](t.value, e.component._group.getRowCount(), e.component._group.getData(), e.component)));
		}), t;
	}
	triggerDownload(e, t, n, r, i) {
...
i(k, "moduleName", "download"), i(k, "downloaders", fe);
function A(e, t) {
	var n = t.mask, r = t.maskLetterChar === void 0 ? "A" : t.maskLetterChar, i = t.maskNumberChar === void 0 ? "9" : t.maskNumberChar, a = t.maskWildcardChar === void 0 ? "*" : t.maskWildcardChar;
	function o(t) {
		var s = n[t];
		s !== void 0 && s !== a && s !== r && s !== i && (e.value = e.value + "" + s, o(t + 1));
	}
	e.addEventListener("keydown", (t) => {
		var o = e.value.length, s = t.key;
		if (t.key.length === 1 && !t.ctrlKey && !t.metaKey) {
			...
			switch (n[o]) {
				...
				case i:
					...
					break;
				case a: break;
				default: if (s !== n[o]) return t.preventDefault(), t.stopPropagation(), !1;
			}
		}
...
function pe(e, t, n, r, i) {
	var a = e.getValue(), o = document.createElement("input");
	if (o.setAttribute("type", i.search ? "search" : "text"), o.style.padding = "4px", o.style.width = "100%", o.style.boxSizing = "border-box", i.elementAttributes && typeof i.elementAttributes == "object") for (let e in i.elementAttributes) e.charAt(0) == "+" ? (e = e.slice(1), o.setAttribute(e, o.getAttribute(e) + i.elementAttributes["+" + e])) : o.setAttribute(e, i.elementAttributes[e]);
	o.value = a === void 0 ? "" : a, t(function() {
		e.getType() === "cell" && (o.focus({ preventScroll: !0 }), o.style.height = "100%", i.selectContents && o.select());
	});
	function s(e) {
...
function me(e, t, n, r, i) {
	var a = e.getValue(), o = i.verticalNavigation || "hybrid", s = String(a == null ? "" : a), c = document.createElement("textarea"), l = 0;
	if (c.style.display = "block", c.style.padding = "2px", c.style.height = "100%", c.style.width = "100%", c.style.boxSizing = "border-box", c.style.whiteSpace = "pre-wrap", c.style.resize = "none", i.elementAttributes && typeof i.elementAttributes == "object") for (let e in i.elementAttributes) e.charAt(0) == "+" ? (e = e.slice(1), c.setAttribute(e, c.getAttribute(e) + i.elementAttributes["+" + e])) : c.setAttribute(e, i.elementAttributes[e]);
	c.value = s, t(function() {
		e.getType() === "cell" && (c.focus({ preventScroll: !0 }), c.style.height = "100%", c.scrollHeight, c.style.height = c.scrollHeight + "px", e.getRow().normalizeHeight(), i.selectContents && c.select());
	});
	function u(t) {
...
function he(e, t, n, r, i) {
	var a = e.getValue(), o = i.verticalNavigation || "editor", s = document.createElement("input");
	if (s.setAttribute("type", "number"), i.max !== void 0 && s.setAttribute("max", i.max), i.min !== void 0 && s.setAttribute("min", i.min), i.step !== void 0 && s.setAttribute("step", i.step), s.style.padding = "4px", s.style.width = "100%", s.style.boxSizing = "border-box", i.elementAttributes && typeof i.elementAttributes == "object") for (let e in i.elementAttributes) e.charAt(0) == "+" ? (e = e.slice(1), s.setAttribute(e, s.getAttribute(e) + i.elementAttributes["+" + e])) : s.setAttribute(e, i.elementAttributes[e]);
	s.value = a;
	var c = function(e) {
		l();
	};
	t(function() {
		e.getType() === "cell" && (s.removeEventListener("blur", c), s.focus({ preventScroll: !0 }), s.style.height = "100%", s.addEventListener("blur", c), i.selectContents && s.select());
	});
	function l() {
		var e = s.value;
...
function ge(e, t, n, r, i) {
	...
	o.value = a, t(function() {
		e.getType() === "cell" && (o.focus({ preventScroll: !0 }), o.style.height = "100%");
	});
	function s() {
		var e = o.value;
		!isNaN(e) && e !== "" && (e = Number(e)), e == a ? r() : n(e) && (a = e);
...
function _e(e, t, n, r, i) {
	var a = i.format, o = i.verticalNavigation || "editor", s = a ? window.DateTime || luxon.DateTime : null, c = e.getValue(), l = document.createElement("input");
	function u(e) {
		return (s.isDateTime(e) ? e : a === "iso" ? s.fromISO(String(e)) : s.fromFormat(String(e), a)).toFormat("yyyy-MM-dd");
	}
	if (l.type = "date", l.style.padding = "4px", l.style.width = "100%", l.style.boxSizing = "border-box", i.max && l.setAttribute("max", a ? u(i.max) : i.max), i.min && l.setAttribute("min", a ? u(i.min) : i.min), i.elementAttributes && typeof i.elementAttributes == "object") for (let e in i.elementAttributes) e.charAt(0) == "+" ? (e = e.slice(1), l.setAttribute(e, l.getAttribute(e) + i.elementAttributes["+" + e])) : l.setAttribute(e, i.elementAttributes[e]);
	c = c === void 0 ? "" : c, a && (s ? c = u(c) : console.error("Editor Error - 'date' editor 'format' param is dependant on luxon.js")), l.value = c, t(function() {
		e.getType() === "cell" && (l.focus({ preventScroll: !0 }), l.style.height = "100%", i.selectContents && l.select());
	});
	function d() {
		var e = l.value, t;
		if (c == null && e !== "" || e !== c) {
...
function ve(e, t, n, r, i) {
	var a = i.format, o = i.verticalNavigation || "editor", s = a ? window.DateTime || luxon.DateTime : null, c, l = e.getValue(), u = document.createElement("input");
	if (u.type = "time", u.style.padding = "4px", u.style.width = "100%", u.style.boxSizing = "border-box", i.elementAttributes && typeof i.elementAttributes == "object") for (let e in i.elementAttributes) e.charAt(0) == "+" ? (e = e.slice(1), u.setAttribute(e, u.getAttribute(e) + i.elementAttributes["+" + e])) : u.setAttribute(e, i.elementAttributes[e]);
	l = l === void 0 ? "" : l, a && (s ? (c = s.isDateTime(l) ? l : a === "iso" ? s.fromISO(String(l)) : s.fromFormat(String(l), a), l = c.toFormat("HH:mm")) : console.error("Editor Error - 'date' editor 'format' param is dependant on luxon.js")), u.value = l, t(function() {
		e.getType() == "cell" && (u.focus({ preventScroll: !0 }), u.style.height = "100%", i.selectContents && u.select());
	});
	function d() {
		var e = u.value, t;
		if (l == null && e !== "" || e !== l) {
...
function ye(e, t, n, r, i) {
	var a = i.format, o = i.verticalNavigation || "editor", s = a ? this.table.dependencyRegistry.lookup(["luxon", "DateTime"], "DateTime") : null, c, l = e.getValue(), u = document.createElement("input");
	if (u.type = "datetime-local", u.style.padding = "4px", u.style.width = "100%", u.style.boxSizing = "border-box", i.elementAttributes && typeof i.elementAttributes == "object") for (let e in i.elementAttributes) e.charAt(0) == "+" ? (e = e.slice(1), u.setAttribute(e, u.getAttribute(e) + i.elementAttributes["+" + e])) : u.setAttribute(e, i.elementAttributes[e]);
...
var be = class {
	...
	_createInputElement() {
		...
		if (t.setAttribute("type", this.params.clearable ? "search" : "text"), t.style.padding = "4px", t.style.width = "100%", t.style.boxSizing = "border-box", this.params.autocomplete || (t.style.cursor = "default", t.style.caretColor = "transparent"), e && typeof e == "object") for (let n in e) n.charAt(0) == "+" ? (n = n.slice(1), t.setAttribute(n, t.getAttribute(n) + e["+" + n])) : t.setAttribute(n, e[n]);
	...
	_scrollToValue(e) {
		...
		var n = this.displayItems.find((e) => e.label !== void 0 && e.label.toLowerCase().startsWith(this.filterTerm));
		n && this._focusItem(n), this.filterTimeout = setTimeout(() => {
			this.filterTerm = "";
		}, 800);
	}
	_focusItem(e) {
	...
	_ajaxRequest(e, t) {
		var n = this.params.filterRemote ? { term: t } : {};
		return e = h(e, {}, n), fetch(e).then((e) => e.ok ? e.json().catch((e) => (console.warn("List Ajax Load Error - Invalid JSON returned", e), Promise.reject(e))) : (console.error("List Ajax Load Error - Connection Error: " + e.status, e.statusText), Promise.reject(e))).catch((e) => (console.error("List Ajax Load Error - Connection Error: ", e), Promise.reject(e)));
	}
	_uniqueColumnValues(e) {
		var t = {}, n = this.table.getData(this.params.valuesLookup), r = e ? this.table.columnManager.getColumnByField(e) : this.cell.getColumn()._getSelf();
		return r ? n.forEach((e) => {
			var n = r.getFieldValue(e);
			this._emptyValueCheck(n) || (this.params.multiselect && Array.isArray(n) ? n.forEach((e) => {
				this._emptyValueCheck(e) || (t[e] = !0);
			}) : t[n] = !0);
	...
	_parseListGroup(e, t) {
		...
		return e.options.forEach((e) => {
			this._parseListItem(e, n.options, t);
		}), n;
	}
	_sortOptions(e) {
		var t;
	...
	_sortGroup(e, t) {
		t.sort((t, n) => e(t.label, n.label, t.value, n.value, t.original, n.original)), t.forEach((t) => {
			t.group && this._sortGroup(e, t.options);
		});
	}
	_defaultSortFunction(e, t) {
		var n, r, i, a, o = 0, s, c = /(\d+)|(\D+)/g, l = /\d/, u = 0;
		if (this.params.sort === "desc" && ([e, t] = [t, e]), !e && e !== 0) u = !t && t !== 0 ? 0 : -1;
		else if (!t && t !== 0) u = 1;
		else {
	...
	_filterOptions() {
		...
		return t ? (this.filtered = !0, this.data.forEach((n) => {
			this._filterItem(e, t, n);
		})) : this.filtered = !1, this.data;
	}
	_filterItem(e, t, n) {
		var r = !1;
		return n.group ? (n.options.forEach((n) => {
			this._filterItem(e, t, n) && (r = !0);
		}), n.visible = r) : n.visible = e(t, n.label, n.value, n.original), n.visible;
	}
	_defaultFilterFunc(e, t, n, r) {
	...
	_buildItem(e) {
		...
		if (!this.filtered || e.visible) {
			...
			this._styleItem(e), this.listEl.appendChild(t), e.group ? e.options.forEach((e) => {
				this._buildItem(e);
	...
	_chooseItem(e, t) {
		var n;
		this.typing = !1, this.params.multiselect ? (n = this.currentItems.indexOf(e), n > -1 ? (this.currentItems.splice(n, 1), e.selected = !1) : (this.currentItems.push(e), e.selected = !0), this.input.value = this.currentItems.map((e) => e.label).join(","), this._styleItem(e)) : (this.currentItems = [e], e.selected = !0, this.input.value = e.label, this._styleItem(e), t || this._resolveValue()), this._focusItem(e);
	}
	_resolveValue(e) {
		var t, n;
		if (this.popup && this.popup.hide(!0), this.params.multiselect) t = this.currentItems.map((e) => e.value);
		else if (e && this.params.autocomplete && this.typing) if (this.params.freetext || this.params.allowEmpty && this.input.value === "") t = this.input.value;
		else {
			this.actions.cancel();
			return;
		}
...
function Se(e, t, n, r, i) {
	var a = this, o = e.getElement(), s = e.getValue(), c = o.getElementsByTagName("svg").length || 5, l = o.getElementsByTagName("svg")[0] ? o.getElementsByTagName("svg")[0].getAttribute("width") : 14, u = [], d = document.createElement("div"), f = document.createElementNS("http://www.w3.org/2000/svg", "svg");
	function p(e) {
	...
	function m(e) {
		var t = document.createElement("span"), r = f.cloneNode(!0);
...
function Ce(e, t, n, r, i) {
	var a = e.getElement(), o = i.max === void 0 ? a.getElementsByTagName("div")[0] && a.getElementsByTagName("div")[0].getAttribute("max") || 100 : i.max, s = i.min === void 0 ? a.getElementsByTagName("div")[0] && a.getElementsByTagName("div")[0].getAttribute("min") || 0 : i.min, c = (o - s) / 100, l = e.getValue() || 0, u = document.createElement("div"), d = document.createElement("div"), f, p;
	function m() {
		var e = window.getComputedStyle(a, null), t = c * Math.round(d.offsetWidth / ((a.clientWidth - parseInt(e.getPropertyValue("padding-left")) - parseInt(e.getPropertyValue("padding-right"))) / 100)) + s;
		n(t), a.setAttribute("aria-valuenow", t), a.setAttribute("aria-label", l);
	}
	if (u.style.position = "absolute", u.style.right = "0", u.style.top = "0", u.style.bottom = "0", u.style.width = "5px", u.classList.add("tabulator-progress-handle"), d.style.display = "inline-block", d.style.position = "relative", d.style.height = "100%", d.style.backgroundColor = "#488CE9", d.style.maxWidth = "100%", d.style.minWidth = "0%", i.elementAttributes && typeof i.elementAttributes == "object") for (let e in i.elementAttributes) e.charAt(0) == "+" ? (e = e.slice(1), d.setAttribute(e, d.getAttribute(e) + i.elementAttributes["+" + e])) : d.setAttribute(e, i.elementAttributes[e]);
...
function we(e, t, n, r, i) {
	var a = e.getValue(), o = document.createElement("input"), s = i.tristate, c = i.indeterminateValue === void 0 ? null : i.indeterminateValue, l = !1, u = Object.keys(i).includes("trueValue"), d = Object.keys(i).includes("falseValue");
	if (o.setAttribute("type", "checkbox"), o.style.marginTop = "5px", o.style.boxSizing = "border-box", i.elementAttributes && typeof i.elementAttributes == "object") for (let e in i.elementAttributes) e.charAt(0) == "+" ? (e = e.slice(1), o.setAttribute(e, o.getAttribute(e) + i.elementAttributes["+" + e])) : o.setAttribute(e, i.elementAttributes[e]);
	o.value = a, s && (a === void 0 || a === c || a === "") && (l = !0, o.indeterminate = !0), this.table.browser != "firefox" && this.table.browser != "safari" && t(function() {
		e.getType() === "cell" && o.focus({ preventScroll: !0 });
...
function Te(e, t, n, r, i) {
	var a = e._getSelf().column, o, s, c;
	function l(e) {
		var t = e.getValue(), n = "input";
		switch (typeof t) {
			case "number":
				n = "number";
				break;
	...
	return o = i.editorLookup ? i.editorLookup(e) : l(e), i.paramsLookup && (c = typeof i.paramsLookup == "function" ? i.paramsLookup(o, e) : i.paramsLookup[o]), s = this.table.modules.edit.lookupEditor(o, a), s.call(this, e, t, n, r, c || {});
}
var Ee = {
	input: pe,
	textarea: me,
	...
	constructor(t) {
		super(t), this.currentCell = !1, this.mouseClick = !1, this.recursionBlock = !1, this.invalidEdit = !1, this.editedCells = [], this.convertEmptyValues = !1, this.editors = e.editors, this.registerTableOption("editTriggerEvent", "focus"), this.registerTableOption("editorEmptyValue"), this.registerTableOption("editorEmptyValueFunc", this.emptyValueCheck.bind(this)), this.registerColumnOption("editable"), this.registerColumnOption("editor"), this.registerColumnOption("editorParams"), this.registerColumnOption("editorEmptyValue"), this.registerColumnOption("editorEmptyValueFunc"), this.registerColumnOption("cellEditing"), this.registerColumnOption("cellEdited"), this.registerColumnOption("cellEditCancelled"), this.registerTableFunction("getEditedCells", this.getEditedCells.bind(this)), this.registerTableFunction("clearCellEdited", this.clearCellEdited.bind(this)), this.registerTableFunction("navigatePrev", this.navigatePrev.bind(this)), this.registerTableFunction("navigateNext", this.navigateNext.bind(this)), this.registerTableFunction("navigateLeft", this.navigateLeft.bind(this)), this.registerTableFunction("navigateRight", this.navigateRight.bind(this)), this.registerTableFunction("navigateUp", this.navigateUp.bind(this)), this.registerTableFunction("navigateDown", this.navigateDown.bind(this)), this.registerComponentFunction("cell", "isEdited", this.cellIsEdited.bind(this)), this.registerComponentFunction("cell", "clearEdited", this.clearEdited.bind(this)), this.registerComponentFunction("cell", "edit", this.editCell.bind(this)), this.registerComponentFunction("cell", "cancelEdit", this.cellCancelEdit.bind(this)), this.registerComponentFunction("cell", "navigatePrev", this.navigatePrev.bind(this)), this.registerComponentFunction("cell", "navigateNext", this.navigateNext.bind(this)), this.registerComponentFunction("cell", "navigateLeft", this.navigateLeft.bind(this)), this.registerComponentFunction("cell", "navigateRight", this.navigateRight.bind(this)), this.registerComponentFunction("cell", "navigateUp", this.navigateUp.bind(this)), this.registerComponentFunction("cell", "navigateDown", this.navigateDown.bind(this));
	}
	initialize() {
	...
	keybindingNavigateNext(e) {
		var t = this.currentCell, n = this.options("tabEndNewRow");
		t && (this.navigateNext(t, e) || n && (t.getElement().firstChild.blur(), this.invalidEdit || (n = n === !0 ? this.table.addRow({}) : typeof n == "function" ? this.table.addRow(n(t.row.getComponent())) : this.table.addRow(Object.assign({}, n)), n.then(() => {
			setTimeout(() => {
	...
	navigatePrev(e = this.currentCell, t) {
		...
		if (e) {
			...
			if (r = this.table.rowManager.prevDisplayRow(e.row, !0), r && (n = this.findPrevEditableCell(r, r.cells.length), n)) return n.getComponent().edit(), !0;
		}
		return !1;
	}
	navigateNext(e = this.currentCell, t) {
		...
		if (e) {
			...
			if (r = this.table.rowManager.nextDisplayRow(e.row, !0), r && (n = this.findNextEditableCell(r, -1), n)) return n.getComponent().edit(), !0;
		}
		return !1;
	}
	navigateLeft(e = this.currentCell, t) {
		var n, r;
		return e && (t && t.preventDefault(), n = e.getIndex(), r = this.findPrevEditableCell(e.row, n), r) ? (r.getComponent().edit(), !0) : !1;
	}
	navigateRight(e = this.currentCell, t) {
		var n, r;
		return e && (t && t.preventDefault(), n = e.getIndex(), r = this.findNextEditableCell(e.row, n), r) ? (r.getComponent().edit(), !0) : !1;
	}
	navigateUp(e = this.currentCell, t) {
		var n, r;
		return e && (t && t.preventDefault(), n = e.getIndex(), r = this.table.rowManager.prevDisplayRow(e.row, !0), r) ? (r.cells[n].getComponent().edit(), !0) : !1;
	}
	navigateDown(e = this.currentCell, t) {
		var n, r;
		return e && (t && t.preventDefault(), n = e.getIndex(), r = this.table.rowManager.nextDisplayRow(e.row, !0), r) ? (r.cells[n].getComponent().edit(), !0) : !1;
	}
	findNextEditableCell(e, t) {
		var n = !1;
		if (t < e.cells.length - 1) for (var r = t + 1; r < e.cells.length; r++) {
			let t = e.cells[r];
			if (t.column.modules.edit && s.elVisible(t.getElement()) && this.allowEdit(t)) {
				n = t;
				break;
			}
		}
	...
	initializeColumnCheck(e) {
		e.definition.editor !== void 0 && this.initializeColumn(e);
	}
	columnDeleteCheck(e) {
	...
	rowEditableCheck(e) {
		e.getCells().forEach((e) => {
			e.column.modules.edit && typeof e.column.modules.edit.check == "function" && this.updateCellClass(e);
		});
	}
	initializeColumn(e) {
		var t = Object.keys(e.definition).includes("editorEmptyValue"), n = {
			editor: !1,
			blocked: !1,
		...
		n.editor = this.lookupEditor(e.definition.editor, e), n.editor && (e.modules.edit = n);
	}
	lookupEditor(e, t) {
		var n;
		switch (typeof e) {
			case "string":
				this.editors[e] ? n = this.editors[e] : console.warn("Editor Error - No such editor found: ", e);
				break;
			case "function":
				n = e;
				break;
			case "boolean":
				e === !0 && (typeof t.definition.formatter == "function" ? console.warn("Editor Error - Cannot auto lookup editor for a custom formatter: ", t.definition.formatter) : n = this.editors[t.definition.formatter] ? this.editors[t.definition.formatter] : this.editors.input);
				break;
		}
		return n;
	}
	...
	clearEditor(e) {
		var t = this.currentCell, n;
		if (this.invalidEdit = !1, t) {
			for (this.currentCell = !1, n = t.getElement(), this.dispatch("edit-editor-clear", t, e), n.classList.remove("tabulator-editing"); n.firstChild;) n.removeChild(n.firstChild);
	...
	bindEditor(e) {
		if (e.column.modules.edit) {
			var t = this, n = e.getElement(!0);
			this.updateCellClass(e), n.setAttribute("tabindex", 0), n.addEventListener("mousedown", function(e) {
				e.button === 2 ? e.preventDefault() : t.mouseClick = !0;
			}), this.options("editTriggerEvent") === "dblclick" && n.addEventListener("dblclick", function(r) {
				n.classList.contains("tabulator-editing") || (n.focus({ preventScroll: !0 }), t.edit(e, r, !1));
	...
	focusScrollAdjust(e) {
		if (this.table.rowManager.getRenderMode() == "virtual") {
			var t = this.table.rowManager.element.scrollTop, n = this.table.rowManager.element.clientHeight + this.table.rowManager.element.scrollTop, r = e.row.getElement();
			...
			var i = this.table.rowManager.element.scrollLeft, a = this.table.rowManager.element.clientWidth + this.table.rowManager.element.scrollLeft, o = e.getElement();
	...
	edit(e, t, n) {
		var r = this, i = !0, a = function() {}, o = e.getElement(), s = !1, c, l, u;
		if (this.currentCell) {
			!this.invalidEdit && this.currentCell !== e && this.cancelEdit();
			return;
		}
		function d(t) {
			if (r.currentCell === e && !s) {
				var n = r.chain("edit-success", [e, t], !0, !0);
				return n === !0 || r.table.options.validationMode === "highlight" ? (s = !0, r.clearEditor(), e.modules.edit || (e.modules.edit = {}), e.modules.edit.edited = !0, r.editedCells.indexOf(e) == -1 && r.editedCells.push(e), t = r.transformEmptyValues(t, e), e.setValue(t, !0), n === !0) : (s = !0, r.invalidEdit = !0, r.focusCellNoEvent(e, !0), a(), setTimeout(() => {
					s = !1;
				}, 10), !1);
			}
		}
		function f() {
			r.currentCell === e && !s && r.cancelEdit();
		}
		function p(e) {
			a = e;
		}
		if (e.column.modules.edit.blocked) return this.mouseClick = !1, this.blur(o), !1;
		if (t && t.stopPropagation(), i = this.allowEdit(e), i || n) {
			if (r.cancelEdit(), r.currentCell = e, this.focusScrollAdjust(e), l = e.getComponent(), this.mouseClick && (this.mouseClick = !1, e.column.definition.cellClick && e.column.definition.cellClick.call(this.table, t, l)), e.column.definition.cellEditing && e.column.definition.cellEditing.call(this.table, l), this.dispatch("cell-editing", e), this.dispatchExternal("cellEditing", l), u = typeof e.column.modules.edit.params == "function" ? e.column.modules.edit.params(l) : e.column.modules.edit.params, c = e.column.modules.edit.editor.call(r, l, p, d, f, u), this.currentCell && c !== !1) if (c instanceof Node) {
	...
	transformEmptyValues(e, t) {
		var n = t.column.modules.edit, r = n.convertEmptyValues || this.convertEmptyValues, i;
		return r && (i = n.editorEmptyValueFunc || this.options("editorEmptyValueFunc"), i && i(e) && (e = n.convertEmptyValues ? n.editorEmptyValue : this.options("editorEmptyValue"))), e;
	}
	blur(e) {
...
i(j, "moduleName", "edit"), i(j, "editors", Ee);
var De = class {
	constructor(e, t, n, r) {
	...
	generateExportList(t, n, r, i) {
		var a, o, s, c;
		return this.cloneTableStyle = n, this.config = t || {}, this.colVisProp = i, this.colVisPropAttach = this.colVisProp.charAt(0).toUpperCase() + this.colVisProp.slice(1), c = e.columnLookups[r], c && (s = c.call(this.table), s = s.filter((e) => this.columnVisCheck(e))), a = this.config.columnHeaders === !1 ? [] : this.headersToExportRows(this.generateColumnGroupHeaders(s)), s && (s = s.map((e) => e.getComponent())), o = this.bodyToExportRows(this.rowLookup(r), s), a.concat(o);
	}
	generateTable(e, t, n, r) {
		var i = this.generateExportList(e, t, n, r);
		return this.generateTableElement(i);
	}
	rowLookup(t) {
		var n = [], r;
		return typeof t == "function" ? t.call(this.table).forEach((e) => {
			e = this.table.rowManager.findRow(e), e && n.push(e);
		}) : (r = e.rowLookups[t] || e.rowLookups.active, n = r.call(this.table)), Object.assign([], n);
	}
	generateColumnGroupHeaders(e) {
		var t = [];
		return e || (e = this.config.columnGroups === !1 ? this.table.columnManager.columnsByIndex : this.table.columnManager.columns), e.forEach((e) => {
			var n = this.processColumnGroup(e);
			n && t.push(n);
		}), t;
	}
	processColumnGroup(e) {
		var t = e.columns, n = 0, r = {
			title: e.definition["title" + this.colVisPropAttach] || e.definition.title,
			column: e,
			depth: 1
		};
		if (t.length) {
			if (r.subGroups = [], r.width = 0, t.forEach((e) => {
				var t = this.processColumnGroup(e);
				t && (r.width += t.width, r.subGroups.push(t), t.depth > n && (n = t.depth));
			}), r.depth += n, !r.width) return !1;
		} else if (this.columnVisCheck(e)) r.width = 1;
		else return !1;
		return r;
	}
	columnVisCheck(e) {
	...
	headersToExportRows(e) {
		...
		function i(e, r) {
			var a = n - r;
			if (t[r] === void 0 && (t[r] = []), e.height = e.subGroups ? 1 : a - e.depth + 1, t[r].push(e), e.height > 1) for (let n = 1; n < e.height; n++) t[r + n] === void 0 && (t[r + n] = []), t[r + n].push(!1);
			if (e.width > 1) for (let n = 1; n < e.width; n++) t[r].push(!1);
		...
		return e.forEach(function(e) {
			...
			e.forEach((e) => {
				if (e) {
					let n = e.title === void 0 ? "" : e.title;
					t.push(new M(n, e.column.getComponent(), e.width, e.height, e.depth));
				} else t.push(null);
	...
	bodyToExportRows(e, t = []) {
		var n = [];
		return t.length === 0 && this.table.columnManager.columnsByIndex.forEach((e) => {
			this.columnVisCheck(e) && t.push(e.getComponent());
		}), this.config.columnCalcs !== !1 && this.table.modExists("columnCalcs") && (this.table.modules.columnCalcs.topInitialized && e.unshift(this.table.modules.columnCalcs.topRow), this.table.modules.columnCalcs.botInitialized && e.push(this.table.modules.columnCalcs.botRow)), e = e.filter((e) => {
			switch (e.type) {
				case "group": return this.config.rowGroups !== !1;
				case "calc": return this.config.columnCalcs !== !1;
				case "row": return !(this.table.options.dataTree && this.config.dataTree === !1 && e.modules.dataTree.parent);
			}
			return !0;
		}), e.forEach((e, r) => {
			var i = e.getData(this.colVisProp), a = [], o = 0;
			switch (e.type) {
				case "group":
					o = e.level, a.push(new M(e.key, e.getComponent(), t.length, 1));
					break;
				case "calc":
				case "row":
					t.forEach((e) => {
						a.push(new M(e._column.getFieldValue(i), e, 1, 1));
					}), this.table.options.dataTree && this.config.dataTree !== !1 && (o = e.modules.dataTree.index);
					break;
			}
			n.push(new De(e.type, a, e.getComponent(), o));
		}), n;
	}
	generateTableElement(e) {
		var t = document.createElement("table"), n = document.createElement("thead"), r = document.createElement("tbody"), i = this.lookupTableStyles(), a = this.table.options["rowFormatter" + this.colVisPropAttach], o = {};
		return o.rowFormatter = a === null ? this.table.options.rowFormatter : a, this.table.options.dataTree && this.config.dataTree !== !1 && this.table.modExists("columnCalcs") && (o.treeElementField = this.table.modules.dataTree.elementField), o.groupHeader = this.table.options["groupHeader" + this.colVisPropAttach], o.groupHeader && !Array.isArray(o.groupHeader) && (o.groupHeader = [o.groupHeader]), t.classList.add("tabulator-print-table"), this.mapElementStyles(this.table.columnManager.getHeadersElement(), n, [
			"border-top",
			"border-left",
			"border-right",
			"border-bottom",
			...
			switch (e.type) {
				case "header":
					n.appendChild(this.generateHeaderElement(e, o, i));
					break;
				case "group":
					r.appendChild(this.generateGroupElement(e, o, i));
					break;
				case "calc":
					r.appendChild(this.generateCalcElement(e, o, i));
					break;
				case "row":
					a = this.generateRowElement(e, o, i), this.mapElementStyles(t % 2 && i.evenRow ? i.evenRow : i.oddRow, a, [
						"border-top",
						"border-left",
						"border-right",
						"border-bottom",
		...
		}), n.innerHTML && t.appendChild(n), t.appendChild(r), this.mapElementStyles(this.table.element, t, [
			"border-top",
			"border-left",
			"border-right",
			"border-bottom"
	...
	generateHeaderElement(e, t, n) {
		var r = document.createElement("tr");
		return e.columns.forEach((e) => {
			if (e) {
				var t = document.createElement("th"), n = e.component._column.definition.cssClass ? e.component._column.definition.cssClass.split(" ") : [];
				t.colSpan = e.width, t.rowSpan = e.height, t.innerHTML = e.value, this.cloneTableStyle && (t.style.boxSizing = "border-box"), n.forEach(function(e) {
					t.classList.add(e);
					...
					"padding-right",
					"padding-bottom"
				]), e.component._column.visible ? this.mapElementStyles(e.component.getElement(), t, ["width"]) : e.component._column.definition.width && (t.style.width = e.component._column.definition.width + "px"), e.component._column.parent && e.component._column.parent.isGroup ? this.mapElementStyles(e.component._column.parent.groupElement, t, ["border-top"]) : this.mapElementStyles(e.component.getElement(), t, ["border-top"]), e.component._column.isGroup ? this.mapElementStyles(e.component.getElement(), t, ["border-bottom"]) : this.mapElementStyles(this.table.columnManager.getElement(), t, ["border-bottom"]), r.appendChild(t);
			}
		}), r;
	}
	generateGroupElement(e, t, n) {
		var r = document.createElement("tr"), i = document.createElement("td"), a = e.columns[0];
		return r.classList.add("tabulator-print-table-row"), t.groupHeader && t.groupHeader[e.indent] ? a.value = t.groupHeader[e.indent](a.value, e.component._group.getRowCount(), e.component._group.getData(), e.component) : t.groupHeader !== !1 && (a.value = e.component._group.generator(a.value, e.component._group.getRowCount(), e.component._group.getData(), e.component)), i.colSpan = a.width, i.innerHTML = a.value, r.classList.add("tabulator-print-table-group"), r.classList.add("tabulator-group-level-" + e.indent), a.component.isVisible() && r.classList.add("tabulator-group-visible"), this.mapElementStyles(n.firstGroup, r, [
			"border-top",
			"border-left",
			"border-right",
			"border-bottom",
	...
	generateCalcElement(e, t, n) {
		var r = this.generateRowElement(e, t, n);
		return r.classList.add("tabulator-print-table-calcs"), this.mapElementStyles(n.calcRow, r, [
			"border-top",
			"border-left",
			"border-right",
			"border-bottom",
	...
	generateRowElement(e, t, n) {
		var r = document.createElement("tr");
		if (r.classList.add("tabulator-print-table-row"), e.columns.forEach((i, a) => {
			if (i) {
				var o = document.createElement("td"), s = i.component._column, c = this.table, l = c.columnManager.findColumnIndex(s), u = i.value, d, f, p = {
					modules: {},
					getValue: function() {
						return u;
					},
				...
				if ((s.definition.cssClass ? s.definition.cssClass.split(" ") : []).forEach(function(e) {
					o.classList.add(e);
				}), this.table.modExists("format") && this.config.formatCells !== !1) u = this.table.modules.format.formatExportValue(p, this.colVisProp);
				...
				u instanceof Node ? o.appendChild(u) : o.innerHTML = u, f = [
					"padding-top",
					"padding-left",
					"padding-right",
					"padding-bottom",
					...
					"font-size",
					"text-align"
				], s.isRowHeader ? (d = n.styleRowHeader, f.push("background-color")) : d = n.styleCells && n.styleCells[l] ? n.styleCells[l] : n.firstCell, d && (this.mapElementStyles(d, o, f), s.definition.align && (o.style.textAlign = s.definition.align)), this.table.options.dataTree && this.config.dataTree !== !1 && (t.treeElementField && t.treeElementField == s.field || !t.treeElementField && a == 0) && (e.component._row.modules.dataTree.controlEl && o.insertBefore(e.component._row.modules.dataTree.controlEl.cloneNode(!0), o.firstChild), e.component._row.modules.dataTree.branchEl && o.insertBefore(e.component._row.modules.dataTree.branchEl.cloneNode(!0), o.firstChild)), r.appendChild(o), p.modules.format && p.modules.format.renderedCallback && p.modules.format.renderedCallback();
			}
	...
	getHtml(e, t, n, r) {
		var i = this.generateExportList(n || this.table.options.htmlOutputConfig, t, e, r || "htmlOutput");
		return this.generateHTMLTable(i);
	}
	mapElementStyles(e, t, n) {
...
i(N, "moduleName", "export"), i(N, "columnLookups", Oe), i(N, "rowLookups", ke);
var Ae = {
	"=": function(e, t, n, r) {
		return t == e;
	},
	...
	regex: function(e, t, n, r) {
		return typeof e == "string" && (e = new RegExp(e)), e.test(t);
	},
	like: function(e, t, n, r) {
		return e == null ? t === e : t == null ? !1 : String(t).toLowerCase().indexOf(e.toLowerCase()) > -1;
	},
	keywords: function(e, t, n, r) {
		var i = e.toLowerCase().split(r.separator === void 0 ? " " : r.separator), a = String(t == null ? "" : t).toLowerCase(), o = [];
		return i.forEach((e) => {
			a.includes(e) && o.push(!0);
		}), r.matchAll ? o.length === i.length : !!o.length;
	},
	starts: function(e, t, n, r) {
		return e == null ? t === e : t == null ? !1 : String(t).toLowerCase().startsWith(e.toLowerCase());
	},
	ends: function(e, t, n, r) {
	...
	tableBuilt() {
		this.table.options.initialFilter && this.setFilter(this.table.options.initialFilter), this.table.options.initialHeaderFilter && this.table.options.initialHeaderFilter.forEach((e) => {
			...
			if (t) this.setHeaderFilterValue(t, e.value);
			else return console.warn("Column Filter Error - No matching column found:", e.field), !1;
		}), this.tableInitialized = !0;
	}
	remoteFilterParams(e, t, n, r) {
	...
	userSetFilter(e, t, n, r) {
		this.setFilter(e, t, n, r), this.refreshFilter();
	}
	userRefreshFilter() {
		this.refreshFilter();
	}
	userAddFilter(e, t, n, r) {
		this.addFilter(e, t, n, r), this.refreshFilter();
	}
	userSetHeaderFilterFocus(e) {
		var t = this.table.columnManager.findColumn(e);
		if (t) this.setHeaderFilterFocus(t);
		else return console.warn("Column Filter Focus Error - No matching column found:", e), !1;
	}
	...
	userSetHeaderFilterValue(e, t) {
		var n = this.table.columnManager.findColumn(e);
		if (n) this.setHeaderFilterValue(n, t);
		else return console.warn("Column Filter Error - No matching column found:", e), !1;
	}
	userRemoveFilter(e, t, n) {
		this.removeFilter(e, t, n), this.refreshFilter();
	}
	userClearFilter(e) {
	...
	searchRows(e, t, n) {
		return this.search("rows", e, t, n);
	}
	searchData(e, t, n) {
		return this.search("data", e, t, n);
	}
	initializeColumnHeaderFilter(e) {
		e.definition.headerFilter && this.initializeColumn(e);
	}
	initializeColumn(t, n) {
		var r = this, i = t.getField();
		function a(n) {
			var a = t.modules.filter.tagType == "input" && t.modules.filter.attrType == "text" || t.modules.filter.tagType == "textarea" ? "partial" : "match", o = "", s = "", c;
			if (t.modules.filter.prevSuccess === void 0 || t.modules.filter.prevSuccess !== n) {
				if (t.modules.filter.prevSuccess = n, t.modules.filter.emptyFunc(n)) delete r.headerFilters[i];
				else {
					switch (t.modules.filter.value = n, typeof t.definition.headerFilterFunc) {
						case "string":
							e.filters[t.definition.headerFilterFunc] ? (o = t.definition.headerFilterFunc, c = function(r) {
								var i = t.definition.headerFilterFuncParams || {}, a = t.getFieldValue(r);
								return i = typeof i == "function" ? i(n, a, r) : i, e.filters[t.definition.headerFilterFunc](n, a, r, i);
							}) : console.warn("Header Filter Error - Matching filter function not found: ", t.definition.headerFilterFunc);
							break;
						case "function":
							c = function(e) {
								var r = t.definition.headerFilterFuncParams || {}, i = t.getFieldValue(e);
								return r = typeof r == "function" ? r(n, i, e) : r, t.definition.headerFilterFunc(n, i, e, r);
							}, o = c;
							break;
					}
					if (!c) switch (a) {
	...
	generateHeaderFilterElement(e, t, n) {
		var r = this, i = e.modules.filter.success, a = e.getField(), o, s, c, l, u, d, f, p;
		...
		if (e.modules.filter.headerElement && e.modules.filter.headerElement.parentNode && e.contentElement.removeChild(e.modules.filter.headerElement.parentNode), a) {
			switch (e.modules.filter.emptyFunc = e.definition.headerFilterEmptyCheck || function(e) {
				...
				case "string":
					r.table.modules.edit.editors[e.definition.headerFilter] ? (s = r.table.modules.edit.editors[e.definition.headerFilter], (e.definition.headerFilter === "tick" || e.definition.headerFilter === "tickCross") && !e.definition.headerFilterEmptyCheck && (e.modules.filter.emptyFunc = function(e) {
						return e !== !0 && e !== !1;
				...
				case "function":
					...
					break;
				case "boolean":
					e.modules.edit && e.modules.edit.editor ? s = e.modules.edit.editor : e.definition.formatter && r.table.modules.edit.editors[e.definition.formatter] ? (s = r.table.modules.edit.editors[e.definition.formatter], (e.definition.formatter === "tick" || e.definition.formatter === "tickCross") && !e.definition.headerFilterEmptyCheck && (e.modules.filter.emptyFunc = function(e) {
						return e !== !0 && e !== !1;
			...
			if (s) {
				...
				}, f = e.definition.headerFilterParams || {}, f = typeof f == "function" ? f.call(r.table, l) : f, c = s.call(this.table.modules.edit, l, h, i, m, f), !c) {
				...
				r.langBind("headerFilters|columns|" + e.definition.field, function(t) {
					c.setAttribute("placeholder", t !== void 0 && t ? t : e.definition.headerFilterPlaceholder || r.langText("headerFilters|default"));
				...
				}, e.modules.filter.headerElement = c, e.modules.filter.attrType = c.hasAttribute("type") ? c.getAttribute("type").toLowerCase() : "", e.modules.filter.tagType = c.tagName.toLowerCase(), e.definition.headerFilterLiveFilter !== !1 && (e.definition.headerFilter === "autocomplete" || e.definition.headerFilter === "tickCross" || (e.definition.editor === "autocomplete" || e.definition.editor === "tickCross") && e.definition.headerFilter === !0 || (c.addEventListener("keyup", d), c.addEventListener("search", d), e.modules.filter.attrType == "number" && c.addEventListener("change", function(e) {
					i(c.value);
				}), e.modules.filter.attrType == "text" && this.table.browser !== "ie" && c.setAttribute("type", "search")), (e.modules.filter.tagType == "input" || e.modules.filter.tagType == "select" || e.modules.filter.tagType == "textarea") && c.addEventListener("mousedown", function(e) {
					e.stopPropagation();
				})), o.appendChild(c), e.contentElement.appendChild(o), n || r.headerFilterColumns.push(e), p && p();
			}
	...
	addFilter(e, t, n, r) {
		...
		Array.isArray(e) || (e = [{
			...
			e = this.findFilter(e), e && (this.filterList.push(e), i = !0);
		}), i && this.trackChanges();
	}
	findFilter(t) {
		var n;
		...
		var r = !1;
		return typeof t.field == "function" ? r = function(e) {
	...
	findSubFilters(e) {
		var t = [];
		return e.forEach((e) => {
			e = this.findFilter(e), e && t.push(e);
		}), t.length ? t : !1;
	}
	getFilters(e, t) {
		var n = [];
		return e && (n = this.getHeaderFilters()), t && n.forEach(function(e) {
			typeof e.type == "function" && (e.type = "function");
	...
	filtersToArray(e, t) {
		...
		return e.forEach((e) => {
			var r;
			Array.isArray(e) ? n.push(this.filtersToArray(e, t)) : (r = {
				field: e.field,
				type: e.type,
				value: e.value
			}, t && typeof r.type == "function" && (r.type = "function"), n.push(r));
		}), n;
	}
	getHeaderFilters() {
		var e = [];
	...
	removeFilter(e, t, n) {
		Array.isArray(e) || (e = [{
			...
			var t = -1;
			t = typeof e.field == "object" ? this.filterList.findIndex((t) => e === t) : this.filterList.findIndex((t) => e.field === t.field && e.type === t.type && e.value === t.value), t > -1 ? this.filterList.splice(t, 1) : console.warn("Filter Error - No matching filter type found, ignoring: ", e.type);
		}), this.trackChanges();
	}
	clearFilter(e) {
	...
	clearHeaderFilter() {
		this.headerFilters = {}, this.prevHeaderFilterChangeCheck = "{}", this.headerFilterColumns.forEach((e) => {
			e.modules.filter.value !== void 0 && delete e.modules.filter.value, e.modules.filter.prevSuccess = void 0, this.reloadHeaderFilter(e);
		}), this.trackChanges();
	}
	search(e, t, n, r) {
		var i = [], a = [];
		return Array.isArray(t) || (t = [{
			...
			e = this.findFilter(e), e && a.push(e);
		}), this.table.rowManager.rows.forEach((t) => {
			var n = !0;
			a.forEach((e) => {
				this.filterRecurse(e, t.getData()) || (n = !1);
			}), n && i.push(e === "data" ? t.getData("data") : t.getComponent());
		}), i;
	}
	filter(e, t) {
		var n = [], r = [];
		return this.subscribedExternal("dataFiltering") && this.dispatchExternal("dataFiltering", this.getFilters(!0)), this.table.options.filterMode !== "remote" && (this.filterList.length || Object.keys(this.headerFilters).length) ? e.forEach((e) => {
			this.filterRow(e) && n.push(e);
		}) : n = e.slice(0), this.subscribedExternal("dataFiltered") && (n.forEach((e) => {
			r.push(e.getComponent());
		}), this.dispatchExternal("dataFiltered", this.getFilters(!0), r)), n;
	}
	filterRow(e, t) {
		var n = !0, r = e.getData();
		for (var i in this.filterList.forEach((e) => {
			this.filterRecurse(e, r) || (n = !1);
	...
	filterRecurse(e, t) {
		var n = !1;
		return Array.isArray(e) ? e.forEach((e) => {
			this.filterRecurse(e, t) && (n = !0);
		}) : n = e.func(t), n;
	}
};
i(je, "moduleName", "filter"), i(je, "filters", Ae);
function Me(e, t, n) {
...
function Fe(e, t, n) {
	var r = parseFloat(e.getValue()), i = "", a, o, s, c, l, u = t.decimal || ".", d = t.thousand || ",", f = t.negativeSign || "-", p = t.symbol || "", m = !!t.symbolAfter, h = t.precision === void 0 ? 2 : t.precision;
...
function Ie(e, t, n) {
	var r = e.getValue(), i = t.urlPrefix || "", a = t.download, o = r, c = document.createElement("a"), l;
	function u(e, t) {
		var n = t[e.shift()];
		return e.length && typeof n == "object" ? u(e, n) : n;
	}
	if (t.labelField && (l = e.getData(), o = u(t.labelField.split(this.table.options.nestedFieldSeparator), l)), t.label) switch (typeof t.label) {
		case "string":
			o = t.label;
			break;
		case "function":
	...
	if (o) {
		if (t.urlField && (l = e.getData(), r = s.retrieveNestedData(this.table.options.nestedFieldSeparator, t.urlField, l)), t.url) switch (typeof t.url) {
			case "string":
				r = t.url;
				break;
			case "function":
		...
		return c.setAttribute("href", i + r), t.target && c.setAttribute("target", t.target), t.download && (a = typeof a == "function" ? a(e) : a === !0 ? "" : a, c.setAttribute("download", a)), c.innerHTML = this.emptyToSpace(this.sanitizeHTML(o)), c;
	} else return "&nbsp;";
}
function Le(e, t, n) {
	var r = document.createElement("img"), i = e.getValue();
	switch (t.urlPrefix && (i = t.urlPrefix + e.getValue()), t.urlSuffix && (i += t.urlSuffix), r.setAttribute("src", i), typeof t.height) {
		case "number":
...
function Re(e, t, n) {
	var r = e.getValue(), i = e.getElement(), a = t.allowEmpty, o = t.allowTruthy, s = Object.keys(t).includes("trueValue"), c = t.tickElement === void 0 ? "<svg enable-background=\"new 0 0 24 24\" height=\"14\" width=\"14\" viewBox=\"0 0 24 24\" xml:space=\"preserve\" ><path fill=\"#2DC214\" clip-rule=\"evenodd\" d=\"M21.652,3.211c-0.293-0.295-0.77-0.295-1.061,0L9.41,14.34  c-0.293,0.297-0.771,0.297-1.062,0L3.449,9.351C3.304,9.203,3.114,9.13,2.923,9.129C2.73,9.128,2.534,9.201,2.387,9.351  l-2.165,1.946C0.078,11.445,0,11.63,0,11.823c0,0.194,0.078,0.397,0.223,0.544l4.94,5.184c0.292,0.296,0.771,0.776,1.062,1.07  l2.124,2.141c0.292,0.293,0.769,0.293,1.062,0l14.366-14.34c0.293-0.294,0.293-0.777,0-1.071L21.652,3.211z\" fill-rule=\"evenodd\"/></svg>" : t.tickElement, l = t.crossElement === void 0 ? "<svg enable-background=\"new 0 0 24 24\" height=\"14\" width=\"14\"  viewBox=\"0 0 24 24\" xml:space=\"preserve\" ><path fill=\"#CE1515\" d=\"M22.245,4.015c0.313,0.313,0.313,0.826,0,1.139l-6.276,6.27c-0.313,0.312-0.313,0.826,0,1.14l6.273,6.272  c0.313,0.313,0.313,0.826,0,1.14l-2.285,2.277c-0.314,0.312-0.828,0.312-1.142,0l-6.271-6.271c-0.313-0.313-0.828-0.313-1.141,0  l-6.276,6.267c-0.313,0.313-0.828,0.313-1.141,0l-2.282-2.28c-0.313-0.313-0.313-0.826,0-1.14l6.278-6.269  c0.313-0.312,0.313-0.826,0-1.14L1.709,5.147c-0.314-0.313-0.314-0.827,0-1.14l2.284-2.278C4.308,1.417,4.821,1.417,5.135,1.73  L11.405,8c0.314,0.314,0.828,0.314,1.141,0.001l6.276-6.267c0.312-0.312,0.826-0.312,1.141,0L22.245,4.015z\"/></svg>" : t.crossElement;
...
function ze(e, t, n) {
	var r = this.table.dependencyRegistry.lookup(["luxon", "DateTime"], "DateTime"), i = t.inputFormat || "yyyy-MM-dd HH:mm:ss", a = t.outputFormat || "dd/MM/yyyy HH:mm:ss", o = t.invalidPlaceholder === void 0 ? "" : t.invalidPlaceholder, s = e.getValue();
	if (r !== void 0) {
		var c = r.isDateTime(s) ? s : i === "iso" ? r.fromISO(String(s)) : r.fromFormat(String(s), i);
		return c.isValid ? (t.timezone && (c = c.setZone(t.timezone)), c.toFormat(a)) : o === !0 || !s ? s : typeof o == "function" ? o(s) : o;
	} else console.error("Format Error - 'datetime' formatter is dependant on luxon.js");
}
function Be(e, t, n) {
	var r = this.table.dependencyRegistry.lookup(["luxon", "DateTime"], "DateTime"), i = t.inputFormat || "yyyy-MM-dd HH:mm:ss", a = t.invalidPlaceholder === void 0 ? "" : t.invalidPlaceholder, o = t.suffix === void 0 ? !1 : t.suffix, s = t.unit === void 0 ? "days" : t.unit, c = t.humanize === void 0 ? !1 : t.humanize, l = t.date === void 0 ? r.now() : t.date, u = e.getValue();
	if (r !== void 0) {
		var d = r.isDateTime(u) ? u : i === "iso" ? r.fromISO(String(u)) : r.fromFormat(String(u), i);
		return d.isValid ? c ? d.diff(l, s).toHuman() + (o ? " " + o : "") : parseInt(d.diff(l, s)[s]) + (o ? " " + o : "") : a === !0 ? u : typeof a == "function" ? a(u) : a;
...
function He(e, t, n) {
	var r = e.getValue(), i = e.getElement(), a = t && t.stars ? t.stars : 5, o = document.createElement("span"), s = document.createElementNS("http://www.w3.org/2000/svg", "svg"), c = "<polygon fill=\"#FFEA00\" stroke=\"#C1AB60\" stroke-width=\"37.6152\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-miterlimit=\"10\" points=\"259.216,29.942 330.27,173.919 489.16,197.007 374.185,309.08 401.33,467.31 259.216,392.612 117.104,467.31 144.25,309.08 29.274,197.007 188.165,173.919 \"/>", l = "<polygon fill=\"#D2D2D2\" stroke=\"#686868\" stroke-width=\"37.6152\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-miterlimit=\"10\" points=\"259.216,29.942 330.27,173.919 489.16,197.007 374.185,309.08 401.33,467.31 259.216,392.612 117.104,467.31 144.25,309.08 29.274,197.007 188.165,173.919 \"/>";
...
function Ue(e, t, n) {
	var r = this.sanitizeHTML(e.getValue()) || 0, i = document.createElement("span"), a = t && t.max ? t.max : 100, o = t && t.min ? t.min : 0, s = t && t.color !== void 0 ? t.color : [
		"red",
		"orange",
		"green"
	], c = "#666666", l, u;
	if (!(isNaN(r) || e.getValue() === void 0)) {
		switch (i.classList.add("tabulator-traffic-light"), u = parseFloat(r) <= a ? parseFloat(r) : a, u = parseFloat(u) >= o ? parseFloat(u) : o, l = (a - o) / 100, u = Math.round((u - o) / l), typeof s) {
			case "string":
				c = s;
				break;
			case "function":
			...
			case "object": if (Array.isArray(s)) {
				var d = 100 / s.length, f = Math.floor(u / d);
...
function We(e, t = {}, n) {
	var r = this.sanitizeHTML(e.getValue()) || 0, i = e.getElement(), a = t.max ? t.max : 100, o = t.min ? t.min : 0, s = t.legendAlign ? t.legendAlign : "center", c, l = parseFloat(r) <= a ? parseFloat(r) : a, u, d, f;
	switch (l = parseFloat(l) >= o ? parseFloat(l) : o, c = (a - o) / 100, l = Math.round((l - o) / c), typeof t.color) {
		case "string":
			u = t.color;
			break;
		case "function":
			u = t.color(r);
			break;
		case "object": if (Array.isArray(t.color)) {
			let e = 100 / t.color.length, n = Math.floor(l / e);
			n = Math.min(n, t.color.length - 1), n = Math.max(n, 0), u = t.color[n];
			break;
		}
		default: u = "#2DC214";
	}
	...
	switch (typeof t.legendColor) {
		...
		case "object":
			if (Array.isArray(t.legendColor)) {
				let e = 100 / t.legendColor.length, n = Math.floor(l / e);
				n = Math.min(n, t.legendColor.length - 1), n = Math.max(n, 0), f = t.legendColor[n];
			}
			break;
		default: f = "#000";
	}
...
function Je(e, t, n) {
	var r = e.getValue(), i = t.size || 15, a = i + "px", o, s, c = t.hasOwnProperty("onValue") ? t.onValue : !0, l = t.hasOwnProperty("offValue") ? t.offValue : !1, u = t.onTruthy ? r : r === c;
	return o = document.createElement("div"), o.classList.add("tabulator-toggle"), u ? (o.classList.add("tabulator-toggle-on"), o.style.flexDirection = "row-reverse", t.onColor && (o.style.background = t.onColor)) : t.offColor && (o.style.background = t.offColor), o.style.width = 2.5 * i + "px", o.style.borderRadius = a, t.clickable && o.addEventListener("click", (t) => {
		e.setValue(u ? l : c);
...
function Ye(e, t, n) {
	var r = document.createElement("span"), i = e.getRow(), a = e.getTable();
	return i.watchPosition((e) => {
...
function Ze(e, t, n) {
	...
	return r = t.formatterLookup ? t.formatterLookup(e) : o(e), t.paramsLookup && (a = typeof t.paramsLookup == "function" ? t.paramsLookup(r, e) : t.paramsLookup[r]), i = this.table.modules.format.lookupFormatter(r), i.call(this, e, a || {}, n);
}
function Qe(e, t, n) {
	var r = t.delimiter || ",", i = e.getValue(), a = this.table, o;
	return t.valueMap && (o = typeof t.valueMap == "string" ? function(e) {
		return e.map((e) => s.retrieveNestedData(a.options.nestedFieldSeparator, t.valueMap, e));
	} : t.valueMap), Array.isArray(i) ? (o && (i = o(i)), i.join(r)) : i;
}
function $e(e, t, n) {
	var r = t.indent || "	", i = t.multiline === void 0 ? !0 : t.multiline, a = t.replacer || null, o = e.getValue();
...
var et = {
	...
	initializeColumn(e) {
		e.modules.format = this.lookupTypeFormatter(e, ""), e.definition.formatterPrint !== void 0 && (e.modules.format.print = this.lookupTypeFormatter(e, "Print")), e.definition.formatterClipboard !== void 0 && (e.modules.format.clipboard = this.lookupTypeFormatter(e, "Clipboard")), e.definition.formatterHtmlOutput !== void 0 && (e.modules.format.htmlOutput = this.lookupTypeFormatter(e, "HtmlOutput"));
	}
	lookupTypeFormatter(e, t) {
		var n = { params: e.definition["formatter" + t + "Params"] || {} }, r = e.definition["formatter" + t];
	...
	formatHeader(e, t, n) {
		var r, i, a, o;
		return e.definition.titleFormatter ? (r = this.lookupFormatter(e.definition.titleFormatter), a = (t) => {
			...
			getTable: () => this.table
		}, i = e.definition.titleFormatterParams || {}, i = typeof i == "function" ? i() : i, r.call(this, o, i, a)) : t;
	}
	formatValue(e) {
		var t = e.getComponent(), n = typeof e.column.modules.format.params == "function" ? e.column.modules.format.params(t) : e.column.modules.format.params;
		function r(t) {
			e.modules.format || (e.modules.format = {}), e.modules.format.renderedCallback = t, e.modules.format.rendered = !1;
		}
		return e.column.modules.format.formatter.call(this, t, n, r);
	}
	formatExportValue(e, t) {
		var n = e.column.modules.format[t], r;
		if (n) {
			r = typeof n.params == "function" ? n.params(e.getComponent()) : n.params;
			function t(t) {
				e.modules.format || (e.modules.format = {}), e.modules.format.renderedCallback = t, e.modules.format.rendered = !1;
			}
			return n.formatter.call(this, e.getComponent(), r, t);
		} else return this.formatValue(e);
	}
	sanitizeHTML(e) {
		if (e) {
			var t = {
...
i(P, "moduleName", "format"), i(P, "formatters", et);
var tt = class extends l {
	...
	layoutColumnPosition(e) {
		var t = [], n = 0, r = 0;
		this.leftColumns.forEach((r, i) => {
			if (r.modules.frozen.marginValue = n, r.modules.frozen.margin = r.modules.frozen.marginValue + "px", r.visible && (n += r.getWidth()), i == this.leftColumns.length - 1 ? r.modules.frozen.edge = !0 : r.modules.frozen.edge = !1, r.parent.isGroup) {
				var a = this.getColGroupParentElement(r);
				t.includes(a) || (this.layoutElement(a, r), t.push(a)), a.classList.toggle("tabulator-frozen-left", r.modules.frozen.edge && r.modules.frozen.position === "left"), a.classList.toggle("tabulator-frozen-right", r.modules.frozen.edge && r.modules.frozen.position === "right");
			} else this.layoutElement(r.getElement(), r);
			e && r.cells.forEach((e) => {
				this.layoutElement(e.getElement(!0), r);
			});
		}), this.rightColumns.forEach((t, n) => {
			t.modules.frozen.marginValue = r, t.modules.frozen.margin = t.modules.frozen.marginValue + "px", t.visible && (r += t.getWidth()), n == this.rightColumns.length - 1 ? t.modules.frozen.edge = !0 : t.modules.frozen.edge = !1, t.parent.isGroup ? this.layoutElement(this.getColGroupParentElement(t), t) : this.layoutElement(t.getElement(), t), e && t.cells.forEach((e) => {
	...
	layoutRow(e) {
		this.table.options.layout === "fitDataFill" && this.rightColumns.length && (this.table.rowManager.getTableElement().style.minWidth = "calc(100% - " + this.rightMargin + ")"), this.leftColumns.forEach((t) => {
			var n = e.getCell(t);
			n && this.layoutElement(n.getElement(!0), t);
	...
	_calcSpace(e, t) {
		var n = 0;
		for (let r = 0; r < t; r++) e[r].visible && (n += e[r].getWidth());
		return n;
	}
};
i(tt, "moduleName", "frozenColumns");
var nt = class extends l {
	...
	initializeRow(e) {
		var t = this.table.options.frozenRows, n = typeof t;
...
i(nt, "moduleName", "frozenRows");
var rt = class {
	constructor(e) {
		return this._group = e, this.type = "GroupComponent", new Proxy(this, { get: function(e, t, n) {
	...
	addBindings() {
		var e;
		this.groupManager.table.options.groupToggleElement && (e = this.groupManager.table.options.groupToggleElement == "arrow" ? this.arrowElement : this.element, e.addEventListener("click", (e) => {
			this.groupManager.table.options.groupToggleElement === "arrow" && (e.stopPropagation(), e.stopImmediatePropagation()), setTimeout(() => {
				this.toggleVisibility();
			});
		}));
	}
	_createGroup(t, n) {
		var r = n + "_" + t, i = new e(this.groupManager, this, n, t, this.groupManager.groupIDLookups[n].field, this.groupManager.headerGenerator[n] || this.groupManager.headerGenerator[0], this.old ? this.old.groups[r] : !1);
		this.groups[r] = i, this.groupList.push(i);
	}
	_addRowToGroup(e) {
		var t = this.level + 1;
		if (this.hasSubGroups) {
			var n = this.groupManager.groupIDLookups[t].func(e.getData()), r = t + "_" + n;
			this.groupManager.allowedValues && this.groupManager.allowedValues[t] ? this.groups[r] && this.groups[r].addRow(e) : (this.groups[r] || this._createGroup(n, t), this.groups[r].addRow(e));
		}
	}
	_addRow(e) {
	...
	removeRow(e) {
		var t = this.rows.indexOf(e), n = e.getElement();
	...
	removeGroup(e) {
		var t = e.level + "_" + e.key, n;
		this.groups[t] && (delete this.groups[t], n = this.groupList.indexOf(e), n > -1 && this.groupList.splice(n, 1), this.groupList.length || (this.parent ? this.parent.removeGroup(this) : this.groupManager.removeGroup(this)));
	}
	getHeadersAndRows() {
		var e = [];
		...
		if (this.visible = !0, this.groupManager.table.rowManager.getRenderMode() == "basic" && !this.groupManager.table.options.pagination) {
			...
			this.groupList.length ? this.groupList.forEach((t) => {
				t.getHeadersAndRows().forEach((t) => {
					var n = t.getElement();
					e.parentNode.insertBefore(n, e.nextSibling), t.initialize(), e = n;
				});
			}) : this.rows.forEach((t) => {
				var n = t.getElement();
				e.parentNode.insertBefore(n, e.nextSibling), t.initialize(), e = n;
	...
	getRows(e, t) {
		var n = [];
		return t && this.groupList.length ? this.groupList.forEach((r) => {
			n = n.concat(r.getRows(e, t));
		}) : this.rows.forEach(function(t) {
			n.push(e ? t.getComponent() : t);
		}), n;
	}
	...
	reinitialize() {
		this.initialized = !1, this.height = 0, s.elVisible(this.element) && this.initialize(!0);
	}
	setHeight(e) {
	...
	rendered() {}
	getComponent() {
		return this.component || (this.component = new rt(this)), this.component;
	}
}, it = class extends l {
	constructor(e) {
	...
	configureGroupSetup() {
		if (this.table.options.groupBy) {
			var e = this.table.options.groupBy, t = this.table.options.groupStartOpen, n = this.table.options.groupHeader;
			this.allowedValues = this.table.options.groupValues, Array.isArray(e) && Array.isArray(n) && e.length > n.length && console.warn("Error creating group headers, groupHeader array is shorter than groupBy array"), this.headerGenerator = [function() {
				...
				this.headerGenerator[0] = (n, r, i) => (n === void 0 ? "" : n) + "<span>(" + r + " " + (r === 1 ? e : t.groups.items) + ")</span>";
			}), this.groupIDLookups = [], e ? this.table.modExists("columnCalcs") && this.table.options.columnCalcs != "table" && this.table.options.columnCalcs != "both" && this.table.modules.columnCalcs.removeCalcs() : this.table.modExists("columnCalcs") && this.table.options.columnCalcs != "group" && this.table.columnManager.getRealColumns().forEach((e) => {
				...
				var n, r;
				typeof e == "function" ? n = e : (r = this.table.columnManager.getColumnByField(e), n = r ? function(e) {
					return r.getFieldValue(e);
				} : function(t) {
					return t[e];
				}), this.groupIDLookups.push({
					field: typeof e == "function" ? !1 : e,
					func: n,
					values: this.allowedValues ? this.allowedValues[t] : !1
				});
			}), t && (Array.isArray(t) || (t = [t]), t.forEach((e) => {}), this.startOpen = t), n && (this.headerGenerator = Array.isArray(n) ? n : [n]);
	...
	virtualRenderFill() {
		...
		if (this.table.options.groupBy) t = t.filter((e) => e.type !== "group"), e.style.minWidth = t.length ? "" : this.table.columnManager.getWidth() + "px";
		else return t;
	}
	rowAddingIndex(e, t, n) {
		if (this.table.options.groupBy) {
	...
	rowMoving(e, t, n) {
		if (this.table.options.groupBy) {
			!n && t instanceof F && (t = this.table.rowManager.prevDisplayRow(e) || t);
			var r = t instanceof F ? t : t.modules.group, i = e instanceof F ? e : e.modules.group;
	...
	pullGroupListData(e) {
		...
		return e.forEach((e) => {
			...
			var r = [];
			e.hasSubGroups ? (r = this.pullGroupListData(e.groupList), n.level = e.level, n.rowCount = r.length - e.groupList.length, n.headerContent = e.generator(e.key, n.rowCount, e.rows, e), t.push(n), t = t.concat(r)) : (n.level = e.level, n.headerContent = e.generator(e.key, e.rows.length, e.rows, e), n.rowCount = e.getRows().length, t.push(n), e.getRows().forEach((e) => {
	...
	getRowGroup(e) {
		var t = !1;
		return this.options("dataTree") && (e = this.table.modules.dataTree.getTreeParentRoot(e)), this.groupList.forEach((n) => {
			var r = n.getRowGroup(e);
			r && (t = r);
		}), t;
	}
	...
	createGroup(e, t, n) {
		var r = t + "_" + e, i;
		n = n || [], i = new F(this, !1, t, e, this.groupIDLookups[0].field, this.headerGenerator[0], n[r]), this.groups[r] = i, this.groupList.push(i);
	}
	...
	assignRowToGroup(e, t) {
		var n = this.groupIDLookups[0].func(e.getData()), r = !this.groups["0_" + n];
		return r && this.createGroup(n, 0, t), this.groups["0_" + n].addRow(e), !r;
	}
	reassignRowToGroup(e) {
		if (e.type === "row") {
			var t = e.modules.group, n = t.getPath(), r = this.getExpectedPath(e);
			n.length == r.length && n.every((e, t) => e === r[t]) || (t.removeRow(e), this.assignRowToGroup(e, this.groups), this.refreshData(!0));
		}
	}
	getExpectedPath(e) {
		var t = [], n = e.getData();
	...
	scrollHeaders(e) {
		this.table.options.groupBy && (this.table.options.renderHorizontal === "virtual" && (e -= this.table.columnManager.renderer.vDomPadLeft), e += "px", this.groupList.forEach((t) => {
			t.scrollHeader(e);
		}));
	}
	removeGroup(e) {
	...
	checkBasicModeGroupHeaderWidth() {
		...
		this.table.rowManager.getDisplayRows().forEach((n, r) => {
			this.table.rowManager.styleRow(n, r), e.appendChild(n.getElement()), n.initialize(!0), n.type !== "group" && (t = !1);
		}), t ? e.style.minWidth = this.table.columnManager.getWidth() + "px" : e.style.minWidth = "";
	}
};
i(it, "moduleName", "groupRows");
var at = {
	cellEdit: function(e) {
	...
	rowDeleted(e) {
		var t, n;
		this.table.options.groupBy ? (n = e.getComponent().getGroup()._getSelf().rows, t = n.indexOf(e), t && (t = n[t - 1])) : (t = e.table.rowManager.getRowIndex(e), t && (t = e.table.rowManager.rows[t - 1])), this.action("rowDelete", e, {
			data: e.getData(),
			pos: !t,
			index: t
		});
	...
	undo() {
		if (this.index > -1) {
			...
			return e.undoers[t.type].call(this, t), this.index--, this.dispatchExternal("historyUndo", t.type, t.component.getComponent(), t.data), !0;
	...
	redo() {
		if (this.history.length - 1 > this.index) {
			this.index++;
			let t = this.history[this.index];
			return e.redoers[t.type].call(this, t), this.dispatchExternal("historyRedo", t.type, t.component.getComponent(), t.data), !0;
	...
	_rebindRow(e, t) {
		this.history.forEach(function(n) {
			if (n.component instanceof D) n.component === e && (n.component = t);
			else if (n.component instanceof w && n.component.row === e) {
...
i(I, "moduleName", "history"), i(I, "moduleExtensions", st), i(I, "undoers", at), i(I, "redoers", ot);
var ct = class extends l {
	...
	parseTable() {
		var e = this.table.originalElement, t = this.table.options, n = e.getElementsByTagName("th"), r = e.getElementsByTagName("tbody")[0], i = [];
		...
		for (var a = 0; a < r.length; a++) {
			var o = r[a].getElementsByTagName("td"), s = {};
	...
	_extractOptions(e, t, n) {
		var r = e.attributes, i = Object.keys(n || t), a = {};
		for (var o in i.forEach((e) => {
			a[e.toLowerCase()] = e;
		}), r) {
			var s = r[o], c;
			s && typeof s == "object" && s.name && s.name.indexOf("tabulator-") === 0 && (c = s.name.replace("tabulator-", ""), a[c] !== void 0 && (t[a[c]] = this._attribValue(s.value)));
		}
	}
	_attribValue(e) {
	...
	_extractHeaders(e, t) {
		for (var n = 0; n < e.length; n++) {
			var r = e[n], i = !1, a = this._findCol(r.textContent), o;
			a ? i = !0 : a = { title: r.textContent.trim() }, a.field || (a.field = r.textContent.trim().toLowerCase().replaceAll(" ", "_")), o = r.getAttribute("width"), o && !a.width && (a.width = o), this._extractOptions(r, a, this.table.columnManager.optionsList.registeredDefaults), this.fieldIndex[n] = a.field, a.field == this.table.options.index && (this.hasIndex = !0), i || this.table.options.columns.push(a);
		}
	}
...
i(ct, "moduleName", "htmlTableImport");
function lt(e) {
	var t = [], n = 0, r = 0, i = !1;
	for (let a = 0; a < e.length; a++) {
		let o = e[a], s = e[a + 1];
		if (t[n] || (t[n] = []), t[n][r] || (t[n][r] = ""), o == "\"" && i && s == "\"") {
			t[n][r] += o, a++;
			continue;
		}
		if (o == "\"") {
...
function ft(e) {
	var t = this.dependencyRegistry.lookup("XLSX"), n = t.read(e), r = n.Sheets[n.SheetNames[0]];
	return t.utils.sheet_to_json(r, { header: 1 });
}
var pt = {
	csv: lt,
	json: ut,
	...
	lookupImporter(t) {
		var n;
		return t || (t = this.table.options.importFormat), n = typeof t == "string" ? e.importers[t] : t, n || console.error("Import Error - Importer not found:", t), n;
	}
	importFromFile(e, t, n) {
		var r = this.lookupImporter(e);
		if (r) return this.pickFile(t, n).then(this.importData.bind(this, r)).then(this.structureData.bind(this)).then(this.mutateData.bind(this)).then(this.validateData.bind(this)).then(this.setData.bind(this)).catch((e) => (this.dispatch("import-error", e), this.dispatchExternal("importError", e), console.error("Import Error:", e || "Unable to import file"), this.table.dataLoader.alertError(), setTimeout(() => {
	...
	pickFile(e, t) {
		return new Promise((n, r) => {
			...
			i.type = "file", i.accept = e, i.addEventListener("change", (e) => {
				var a = i.files[0], o = new FileReader(), s = this.validateFile(a);
				if (s === !0) {
					switch (this.dispatch("import-importing", i.files), this.dispatchExternal("importImporting", i.files), t || this.table.options.importReader) {
						case "buffer":
						...
						case "url":
							o.readAsDataURL(a);
							break;
						default: o.readAsText(a);
					}
					o.onload = (e) => {
						n(o.result);
					}, o.onerror = (e) => {
						console.warn("File Load Error - Unable to read file"), r(e);
					};
				} else r(s);
			}), this.dispatch("import-choose"), this.dispatchExternal("importChoose"), i.click();
		});
	}
	importData(e, t) {
		var n;
		return this.table.dataLoader.alertLoader(), new Promise((r, i) => {
			setTimeout(() => {
				n = e.call(this.table, t), n instanceof Promise || n ? r(n) : i();
			}, 10);
		});
	}
	structureData(e) {
		var t = [];
		return Array.isArray(e) && e.length && Array.isArray(e[0]) ? (t = this.table.options.autoColumns ? this.structureArrayToObject(e) : this.structureArrayToColumns(e), t) : e;
	}
	mutateData(e) {
		var t = [];
		return Array.isArray(e) ? e.forEach((e) => {
	...
	transformHeader(e) {
		var t = [];
		if (this.table.options.importHeaderTransform) e.forEach((n) => {
			t.push(this.table.options.importHeaderTransform.call(this.table, n, e));
		});
		else return e;
		return t;
	}
	transformData(e) {
		var t = [];
		if (this.table.options.importValueTransform) e.forEach((n) => {
			t.push(this.table.options.importValueTransform.call(this.table, n, e));
		});
		else return e;
		return t;
	}
	structureArrayToObject(e) {
		...
		return e.map((e) => {
			var n = {};
			return e = this.transformData(e), t.forEach((t, r) => {
				n[t] = e[r];
			}), n;
		});
	}
	structureArrayToColumns(e) {
		var t = [], n = this.transformHeader(e[0]), r = this.table.getColumns();
		return r[0] && n[0] && r[0].getDefinition().title === n[0] && e.shift(), e.forEach((e) => {
			var n = {};
			e = this.transformData(e), e.forEach((e, t) => {
				var i = r[t];
				i && (n[i.getField()] = e);
			}), t.push(n);
		}), t;
...
i(L, "moduleName", "import"), i(L, "importers", pt);
var mt = class extends l {
	...
	unsubscribeTouchEvents(e) {
		var t = !0, n = this.eventMap[e];
		if (this.subscribers[e] && !this.subscribedExternal(e)) {
			delete this.subscribers[e];
			for (let e in this.eventMap) this.eventMap[e] === n && this.subscribers[e] && (t = !1);
	...
	initializeColumn(e) {
		var t = e.definition;
		for (let n in this.eventMap) t[n] && (this.subscriptionChanged(n, !0), this.columnSubscribers[n] || (this.columnSubscribers[n] = []), this.columnSubscribers[n].push(e));
	}
	handle(e, t, n) {
	...
	handleTouch(e, t, n, r) {
		...
		switch (e === "column" && (e = "header"), t) {
			case "start":
				i.tap = !0, clearTimeout(i.tapHold), i.tapHold = setTimeout(() => {
					clearTimeout(i.tapHold), i.tapHold = null, i.tap = null, clearTimeout(i.tapDbl), i.tapDbl = null, this.dispatchEvent(e + "TapHold", n, r);
				}, 1e3);
				break;
			case "end":
				i.tap && (i.tap = null, this.dispatchEvent(e + "Tap", n, r)), i.tapDbl ? (clearTimeout(i.tapDbl), i.tapDbl = null, this.dispatchEvent(e + "DblTap", n, r)) : i.tapDbl = setTimeout(() => {
...
var ht = {
	...
	scrollPageUp: function(e) {
		var t = this.table.rowManager, n = t.scrollTop - t.element.clientHeight;
	...
	scrollPageDown: function(e) {
		var t = this.table.rowManager, n = t.scrollTop + t.element.clientHeight, r = t.element.scrollHeight;
	...
	initialize() {
		var t = this.table.options.keybindings, n = {};
	...
	mapBindings(t) {
		for (let n in t) e.actions[n] ? t[n] && (typeof t[n] != "object" && (t[n] = [t[n]]), t[n].forEach((e) => {
	...
	getKeyCode(e) {
		return e.key.length === 1 ? e.key.toUpperCase().charCodeAt(0) : {
			Enter: 13,
			Escape: 27,
			Tab: 9,
			Backspace: 8,
	...
	mapBinding(t, n) {
		...
		n.toString().toLowerCase().split(" ").join("").split("+").forEach((e) => {
			switch (e) {
				case "ctrl":
					r.ctrl = !0;
					break;
				...
				case "meta":
					r.meta = !0;
					break;
				default: e = isNaN(e) ? e.toUpperCase().charCodeAt(0) : parseInt(e), r.keys.push(e), this.watchKeys[e] || (this.watchKeys[e] = []), this.watchKeys[e].push(r);
			}
		});
	}
	bindEvents() {
		...
		this.keyupBinding = function(t) {
			var n = e.getKeyCode(t), r = e.watchKeys[n];
			r && (e.pressedKeys.push(n), r.forEach(function(n) {
				e.checkBinding(t, n);
			}));
		}, this.keydownBinding = function(t) {
			var n = e.getKeyCode(t);
			if (e.watchKeys[n]) {
				var r = e.pressedKeys.indexOf(n);
				r > -1 && e.pressedKeys.splice(r, 1);
			}
	...
	checkBinding(e, t) {
		...
		return e.ctrlKey == t.ctrl && e.shiftKey == t.shift && e.metaKey == t.meta ? (t.keys.forEach((e) => {
			this.pressedKeys.indexOf(e) == -1 && (n = !1);
		}), n && t.action.call(this, e), !0) : !1;
	}
};
i(R, "moduleName", "keybindings"), i(R, "bindings", ht), i(R, "actions", gt);
var _t = class extends l {
	...
	initializeColumnHeaderMenu(e) {
		var t = e.definition.headerMenuIcon, n = document.createElement("span");
		n.classList.add("tabulator-header-popup-button"), t ? (typeof t == "function" && (t = t(e.getComponent())), t instanceof HTMLElement ? n.appendChild(t) : n.innerHTML = t) : n.innerHTML = "&vellip;", n.addEventListener("click", (t) => {
	...
	loadMenuTableCellEvent(e, t, n) {
		n._cell && (n = n._cell), n.column.definition[e] && this.loadMenuEvent(n.column.definition[e], t, n);
	}
	loadMenuTableColumnEvent(e, t, n) {
		n._column && (n = n._column), n.definition[e] && this.loadMenuEvent(n.definition[e], t, n);
	}
	loadMenuEvent(e, t, n) {
		n._group ? n = n._group : n._row && (n = n._row), e = typeof e == "function" ? e.call(this.table, t, n.getComponent()) : e, this.loadMenu(t, n, e);
	}
	loadMenu(e, t, n, r, i) {
		var a = !(e instanceof MouseEvent), o = document.createElement("div"), s;
		if (o.classList.add("tabulator-menu"), a || e.preventDefault(), !(!n || !n.length)) {
			...
			n.forEach((e) => {
				var n = document.createElement("div"), r = e.label, i = e.disabled;
				e.separator ? n.classList.add("tabulator-menu-separator") : (n.classList.add("tabulator-menu-item"), typeof r == "function" && (r = r.call(this.table, t.getComponent())), r instanceof Node ? n.appendChild(r) : n.innerHTML = r, typeof i == "function" && (i = i.call(this.table, t.getComponent())), i ? (n.classList.add("tabulator-menu-item-disabled"), n.addEventListener("click", (e) => {
					e.stopPropagation();
				})) : e.menu && e.menu.length ? n.addEventListener("click", (r) => {
					r.stopPropagation(), this.loadMenu(r, t, e.menu, n, s);
				}) : e.action && n.addEventListener("click", (n) => {
			...
			}), s.show(r || e), s === this.rootPopup && (this.rootPopup.hideOnBlur(() => {
				this.rootPopup = null, this.currentComponent && (this.dispatch("menu-closed", n, s), this.dispatchExternal("menuClosed", this.currentComponent.getComponent()), this.currentComponent = null);
			}), this.currentComponent = t, this.dispatch("menu-opened", n, s), this.dispatchExternal("menuOpened", t.getComponent()));
		}
	}
};
i(_t, "moduleName", "menu");
var vt = class extends l {
	...
	initializeColumn(e) {
		...
		!e.modules.frozen && !e.isGroup && !e.isRowHeader && (r = e.getElement(), n.mousemove = function(n) {
			e.parent === t.moving.parent && ((t.touchMove ? n.touches[0].pageX : n.pageX) - s.elOffset(r).left + t.table.columnManager.contentsElement.scrollLeft > e.getWidth() / 2 ? (t.toCol !== e || !t.toColAfter) && (r.parentNode.insertBefore(t.placeholderElement, r.nextSibling), t.moveColumn(e, !0)) : (t.toCol !== e || t.toColAfter) && (r.parentNode.insertBefore(t.placeholderElement, r), t.moveColumn(e, !1)));
	...
	moveHover(e) {
		var t = this.table.columnManager.getContentsElement(), n = t.scrollLeft, r = (this.touchMove ? e.touches[0].pageX : e.pageX) - s.elOffset(t).left + n, i;
		this.hoverElement.style.left = r - this.startX + "px", r - n < this.autoScrollMargin && (this.autoScrollTimeout || (this.autoScrollTimeout = setTimeout(() => {
			i = Math.max(0, n - 5), this.table.rowManager.getElement().scrollLeft = i, this.autoScrollTimeout = !1;
		}, 1))), n + t.clientWidth - r < this.autoScrollMargin && (this.autoScrollTimeout || (this.autoScrollTimeout = setTimeout(() => {
			i = Math.min(t.clientWidth, n + 5), this.table.rowManager.getElement().scrollLeft = i, this.autoScrollTimeout = !1;
		}, 1)));
	}
};
i(vt, "moduleName", "moveColumn");
var yt = { delete: function(e, t, n) {
	e.delete();
} }, bt = {
	...
	initializeGroupHeader(e) {
		...
		n.mouseup = function(n) {
			...
			var r;
			n.pageY - s.elOffset(e.element).top + t.table.rowManager.element.scrollTop > e.getHeight() / 2 ? (t.toRow !== e || !t.toRowAfter) && (r = e.getElement(), r.parentNode.insertBefore(t.placeholderElement, r.nextSibling), t.moveRow(e, !0)) : (t.toRow !== e || t.toRowAfter) && (r = e.getElement(), r.previousSibling && (r.parentNode.insertBefore(t.placeholderElement, r), t.moveRow(e, !1)));
		}.bind(t), e.modules.moveRow = n;
	}
	initializeRow(e) {
		var t = this, n = {}, r;
		n.mouseup = function(n) {
			...
			var r = e.getElement();
			n.pageY - s.elOffset(r).top + t.table.rowManager.element.scrollTop > e.getHeight() / 2 ? (t.toRow !== e || !t.toRowAfter) && (r.parentNode.insertBefore(t.placeholderElement, r.nextSibling), t.moveRow(e, !0)) : (t.toRow !== e || t.toRowAfter) && (r.parentNode.insertBefore(t.placeholderElement, r), t.moveRow(e, !1));
		}.bind(t), this.hasHandle || (r = e.getElement(), r.addEventListener("mousedown", function(n) {
	...
	bindTouchEvents(e, t) {
		...
		t.addEventListener("touchstart", (t) => {
			this.checkTimeout = setTimeout(() => {
				this.touchMove = !0, r = e.nextRow(), a = r ? r.getHeight() / 2 : 0, i = e.prevRow(), o = i ? i.getHeight() / 2 : 0, s = 0, c = 0, n = !1, this.startMove(t, e);
			}, this.checkPeriod);
		}, { passive: !0 }), this.moving, this.toRow, this.toRowAfter, t.addEventListener("touchmove", (t) => {
			var l, u;
			this.moving && (t.preventDefault(), this.moveHover(t), n || (n = t.touches[0].pageY), l = t.touches[0].pageY - n, l > 0 ? r && l - s > a && (u = r, u !== e && (n = t.touches[0].pageY, u.getElement().parentNode.insertBefore(this.placeholderElement, u.getElement().nextSibling), this.moveRow(u, !0))) : i && -l - c > o && (u = i, u !== e && (n = t.touches[0].pageY, u.getElement().parentNode.insertBefore(this.placeholderElement, u.getElement()), this.moveRow(u, !1))), u && (r = u.nextRow(), s = a, a = r ? r.getHeight() / 2 : 0, i = u.prevRow(), c = o, o = i ? i.getHeight() / 2 : 0));
	...
	setStartPosition(e, t) {
		var n = this.touchMove ? e.touches[0].pageX : e.pageX, r = this.touchMove ? e.touches[0].pageY : e.pageY, i = t.getElement(), a;
	...
	moveHoverTable(e) {
		var t = this.table.rowManager.getElement(), n = t.scrollTop, r = (this.touchMove ? e.touches[0].pageY : e.pageY) - t.getBoundingClientRect().top + n;
	...
	elementRowDrop(e, t, n) {
		this.dispatchExternal("movableRowsElementDrop", e, t, n ? n.getComponent() : !1);
	}
	connectToTables(e) {
		var t;
		this.connectionSelectorsTables && (t = this.commsConnections(this.connectionSelectorsTables), this.dispatchExternal("movableRowsSendingStart", t), this.commsSend(this.connectionSelectorsTables, "moveRow", "connect", { row: e })), this.connectionSelectorsElements && (this.connectionElements = [], Array.isArray(this.connectionSelectorsElements) || (this.connectionSelectorsElements = [this.connectionSelectorsElements]), this.connectionSelectorsElements.forEach((e) => {
			typeof e == "string" ? this.connectionElements = this.connectionElements.concat(Array.prototype.slice.call(document.querySelectorAll(e))) : this.connectionElements.push(e);
	...
	connect(e, t) {
		return this.connectedTable ? (console.warn("Move Row Error - Table cannot accept connection, already connected to table:", this.connectedTable), !1) : (this.connectedTable = e, this.connectedRow = t, this.table.element.classList.add("tabulator-movingrow-receiving"), this.table.rowManager.getDisplayRows().forEach((e) => {
			e.type === "row" && e.modules.moveRow && e.modules.moveRow.mouseup && e.getElement().addEventListener("mouseup", e.modules.moveRow.mouseup);
	...
	disconnect(e) {
		e === this.connectedTable ? (this.connectedTable = !1, this.connectedRow = !1, this.table.element.classList.remove("tabulator-movingrow-receiving"), this.table.rowManager.getDisplayRows().forEach((e) => {
			e.type === "row" && e.modules.moveRow && e.modules.moveRow.mouseup && e.getElement().removeEventListener("mouseup", e.modules.moveRow.mouseup);
	...
	commsReceived(e, t, n) {
		switch (t) {
			case "connect": return this.connect(e, n.row);
			case "disconnect": return this.disconnect(e);
			case "dropcomplete": return this.dropComplete(e, n.row, n.success);
		}
	}
};
i(z, "moduleName", "moveRow"), i(z, "senders", yt), i(z, "receivers", bt);
var xt = {}, B = class e extends l {
	constructor(e) {
		super(e), this.allowedTypes = [
			"",
			"data",
	...
	initializeColumn(e) {
		var t = !1, n = {};
		this.allowedTypes.forEach((r) => {
			var i = "mutator" + (r.charAt(0).toUpperCase() + r.slice(1)), a;
			e.definition[i] && (a = this.lookupMutator(e.definition[i]), a && (t = !0, n[i] = {
				mutator: a,
				params: e.definition[i + "Params"] || {}
			}));
		}), t && (e.modules.mutate = n);
	}
	lookupMutator(t) {
		var n = !1;
		switch (typeof t) {
	...
	transformRow(e, t, n) {
		var r = "mutator" + (t.charAt(0).toUpperCase() + t.slice(1)), i;
		return this.enabled && this.table.columnManager.traverse((a) => {
			var o, s, c;
			a.modules.mutate && (o = a.modules.mutate[r] || a.modules.mutate.mutator || !1, o && (i = a.getFieldValue(n === void 0 ? e : n), (t == "data" && !n || i !== void 0) && (c = a.getComponent(), s = typeof o.params == "function" ? o.params(i, e, t, c) : o.params, a.setFieldValue(e, o.mutator(i, e, t, s, c)))));
		}), e;
	}
	transformCell(e, t) {
		if (e.column.modules.mutate) {
			var n = e.column.modules.mutate.mutatorEdit || e.column.modules.mutate.mutator || !1, r = {};
			if (n) return r = Object.assign(r, e.row.getData()), e.column.setFieldValue(r, t), n.mutator(t, r, "edit", n.params, e.getComponent());
		}
		return t;
	}
	mutateLink(e) {
...
i(B, "moduleName", "mutator"), i(B, "mutators", xt);
function St(e, t, n, r, i) {
	var a = document.createElement("span"), o = document.createElement("span"), s = document.createElement("span"), c = document.createElement("span"), l = document.createElement("span"), u = document.createElement("span");
...
function Ct(e, t, n, r, i) {
	...
	return this.table.modules.localize.langBind("pagination|counter|showing", (e) => {
		o.innerHTML = e;
	}), s.innerHTML = " " + n + " ", this.table.modules.localize.langBind("pagination|counter|of", (e) => {
		c.innerHTML = e;
	}), l.innerHTML = " " + i + " ", this.table.modules.localize.langBind("pagination|counter|pages", (e) => {
		u.innerHTML = e;
...
var wt = {
	...
	rowAddingPosition(e, t) {
		var n = this.table.rowManager, r = n.getDisplayRows(), i;
	...
	scrollVertical(e, t) {
		var n, r, i;
		!t && !this.table.dataLoader.loading && (n = this.table.rowManager.getElement(), r = n.scrollHeight - n.clientHeight - e, i = this.table.options.progressiveLoadScrollMargin || n.clientHeight * 2, r < i && this.nextPage().catch(() => {}));
	}
	...
	generatePageSizeSelectList() {
		...
		if (this.pageSizeSelect) {
			if (Array.isArray(this.table.options.paginationSizeSelector)) e = this.table.options.paginationSizeSelector, this.pageSizes = e, this.pageSizes.indexOf(this.size) == -1 && e.unshift(this.size);
			...
			e.forEach((e) => {
				...
				t.value = e, e === !0 ? this.langBind("pagination|all", function(e) {
					t.innerHTML = e;
	...
	initializePageCounter() {
		var t = this.table.options.paginationCounter, n = null;
		t && (n = typeof t == "function" ? t : e.pageCounters[t], n ? (this.pageCounter = n, this.pageCounterElement = document.createElement("span"), this.pageCounterElement.classList.add("tabulator-page-counter")) : console.warn("Pagination Error - No such page counter found: ", t));
	}
	...
	_setPageCounter(e, t, n) {
		var r;
		if (this.pageCounter) switch (this.mode === "remote" && (t = this.size, n = (this.page - 1) * this.size + 1, e = this.remoteRowCountEstimate), r = this.pageCounter.call(this, t, n, this.page, e, this.max), typeof r) {
			case "object":
			...
			case "undefined":
				...
				break;
			default: this.pageCounterElement.innerHTML = r;
		}
	}
	_setPageButtons() {
		let e = Math.floor((this.count - 1) / 2), t = Math.ceil((this.count - 1) / 2), n = this.max - this.page + e + 1 < this.count ? this.max - this.count + 1 : Math.max(this.page - e, 1), r = this.page <= t ? Math.min(this.count, this.max) : Math.min(this.page + t, this.max);
		...
		for (let e = n; e <= r; e++) e > 0 && e <= this.max && this.pagesElement.appendChild(this._generatePageButton(e));
		this.footerRedraw();
	}
	_generatePageButton(e) {
		var t = document.createElement("button");
		return t.classList.add("tabulator-page"), e == this.page && t.classList.add("active"), t.setAttribute("type", "button"), t.setAttribute("role", "button"), this.langBind("pagination|page_title", (n) => {
			t.setAttribute("aria-label", n + " " + e), t.setAttribute("title", n + " " + e);
	...
	getRows(e) {
		var t = 0, n, r, i, a, o = e.filter((e) => e.type === "row");
		if (this.mode == "local") {
			n = [], this.setMaxRows(e.length), this.size === !0 ? (r = 0, i = e.length) : (r = this.size * (this.page - 1), i = r + parseInt(this.size)), this._setPageButtons();
			for (let o = r; o < i; o++) {
				let r = e[o];
				r && (n.push(r), r.type === "row" && (a || (a = r), t++));
			}
			return this._setPageCounter(o.length, t, a ? o.indexOf(a) + 1 : 0), n;
		} else return this._setPageButtons(), this._setPageCounter(o.length), e.slice(0);
	}
	trigger() {
		var e;
		switch (this.mode) {
			case "local": return e = this.table.rowManager.scrollLeft, this.refreshData(), this.table.rowManager.scrollHorizontal(e), this.dispatchExternal("pageLoaded", this.getPage()), Promise.resolve();
			case "remote": return this.dataChanging = !0, this.reloadData(null).finally(() => {
				this.dataChanging = !1;
			});
			case "progressive_load":
			case "progressive_scroll": return this.reloadData(null, !0);
			default: return console.warn("Pagination Error - no such pagination mode:", this.mode), Promise.reject();
		}
	}
	_parseRemoteData(e) {
		var t, n;
		if (e.last_page === void 0 && console.warn("Remote Pagination Error - Server response missing '" + (this.options("dataReceiveParams").last_page || "last_page") + "' property"), e.data) if (this.max = parseInt(e.last_page) || 1, this.remoteRowCountEstimate = e.last_row === void 0 ? e.last_page * this.size - (this.page == e.last_page ? this.size - e.data.length : 0) : e.last_row, this.progressiveLoad) {
			switch (this.mode) {
				case "progressive_load":
			...
			if (this.page > this.max && (console.warn("Remote Pagination Error - Server returned last page value lower than the current page"), n = this.options("paginationOutOfRange"), n)) return this.setPage(typeof n == "function" ? n.call(this, this.page, this.max) : n);
...
i(V, "moduleName", "page"), i(V, "pageCounters", wt);
var Tt = {
	local: function(e, t) {
	...
	cookie: function(e, t) {
		var n = document.cookie, r = e + "-" + t, i = n.indexOf(r + "="), a, o;
	...
	initialize() {
		if (this.table.options.persistence) {
			var t = this.table.options.persistenceMode, n = this.table.options.persistenceID, r;
			this.mode = t === !0 ? this.localStorageTest() ? "local" : "cookie" : t, this.table.options.persistenceReaderFunc ? typeof this.table.options.persistenceReaderFunc == "function" ? this.readFunc = this.table.options.persistenceReaderFunc : e.readers[this.table.options.persistenceReaderFunc] ? this.readFunc = e.readers[this.table.options.persistenceReaderFunc] : console.warn("Persistence Read Error - invalid reader set", this.table.options.persistenceReaderFunc) : e.readers[this.mode] ? this.readFunc = e.readers[this.mode] : console.warn("Persistence Read Error - invalid reader set", this.mode), this.table.options.persistenceWriterFunc ? typeof this.table.options.persistenceWriterFunc == "function" ? this.writeFunc = this.table.options.persistenceWriterFunc : e.writers[this.table.options.persistenceWriterFunc] ? this.writeFunc = e.writers[this.table.options.persistenceWriterFunc] : console.warn("Persistence Write Error - invalid reader set", this.table.options.persistenceWriterFunc) : e.writers[this.mode] ? this.writeFunc = e.writers[this.mode] : console.warn("Persistence Write Error - invalid writer set", this.mode), this.id = "tabulator-" + (n || this.table.element.getAttribute("id") || ""), this.config = {
				...
				columns: this.table.options.persistence === !0 ? [
					"title",
					"width",
					"visible"
	...
	tableBuilt() {
		var e, t, n;
		this.config.sort && (e = this.load("sort"), e && (this.table.options.initialSort = e)), this.config.filter && (t = this.load("filter"), t && (this.table.options.initialFilter = t)), this.config.headerFilter && (n = this.load("headerFilter"), n && (this.table.options.initialHeaderFilter = n));
	}
	tableRedraw(e) {
	...
	initializeColumn(e) {
		var t, n;
		this.config.columns && (this.defWatcherBlock = !0, t = e.getDefinition(), n = this.config.columns === !0 ? Object.keys(t) : this.config.columns, n.forEach((e) => {
			var n = Object.getOwnPropertyDescriptor(t, e), r = t[e];
			n && Object.defineProperty(t, e, {
				set: (e) => {
					r = e, this.defWatcherBlock || this.save("columns"), n.set && n.set(e);
				},
				get: () => (n.get && n.get(), r)
			});
	...
	load(e, t) {
		var n = this.retrieveData(e);
		return t && (n = n ? this.mergeDefinition(t, n) : t), n;
	}
	retrieveData(e) {
		return this.readFunc ? this.readFunc(this.id, e) : !1;
	}
	mergeDefinition(e, t, n) {
		var r = [];
		return t = t || [], t.forEach((t, i) => {
			var a = this._findColumn(e, t), o;
			a && (n ? o = Object.keys(t) : this.config.columns === !0 || this.config.columns == null ? (o = Object.keys(a), o.push("width")) : o = this.config.columns, o.forEach((e) => {
				e !== "columns" && t[e] !== void 0 && (a[e] = t[e]);
			}), a.columns && (a.columns = this.mergeDefinition(a.columns, t.columns)), r.push(a));
		}), e.forEach((e, n) => {
			this._findColumn(t, e) || (r.length > n ? r.splice(n, 0, e) : r.push(e));
		}), r;
	}
	_findColumn(e, t) {
		...
		return e.find(function(e) {
			switch (n) {
				case "group": return e.title === t.title && e.columns.length === t.columns.length;
				case "field": return e.field === t.field;
				case "object": return e === t;
			}
		});
	}
	save(e) {
	...
	parseColumns(e) {
		...
		return e.forEach((e) => {
			var r = {}, i = e.getDefinition(), a;
			e.isGroup ? (r.title = i.title, r.columns = this.parseColumns(e.getColumns())) : (r.field = e.getField(), this.config.columns === !0 || this.config.columns == null ? (a = Object.keys(i), a.push("width"), a.push("visible")) : a = this.config.columns, a.forEach((t) => {
				switch (t) {
					case "width":
						r.width = e.getWidth();
						break;
					case "visible":
						r.visible = e.visible;
						break;
					default: typeof i[t] != "function" && n.indexOf(t) === -1 && (r[t] = i[t]);
				}
			})), t.push(r);
		}), t;
	}
};
i(H, "moduleName", "persistence"), i(H, "moduleInitOrder", -10), i(H, "readers", Tt), i(H, "writers", Et);
var Dt = class extends l {
	...
	initializeColumnHeaderPopup(e) {
		var t = e.definition.headerPopupIcon, n = document.createElement("span");
		n.classList.add("tabulator-header-popup-button"), t ? (typeof t == "function" && (t = t(e.getComponent())), t instanceof HTMLElement ? n.appendChild(t) : n.innerHTML = t) : n.innerHTML = "&vellip;", n.addEventListener("click", (t) => {
			t.stopPropagation(), t.preventDefault(), this.loadPopupEvent(e.definition.headerPopup, t, e);
		}), e.titleElement.insertBefore(n, e.titleElement.firstChild);
	}
	loadPopupTableCellEvent(e, t, n) {
		n._cell && (n = n._cell), n.column.definition[e] && this.loadPopupEvent(n.column.definition[e], t, n);
	}
	loadPopupTableColumnEvent(e, t, n) {
		n._column && (n = n._column), n.definition[e] && this.loadPopupEvent(n.definition[e], t, n);
	}
	loadPopupEvent(e, t, n, r) {
		var i;
		function a(e) {
			i = e;
		}
		n._group ? n = n._group : n._row && (n = n._row), e = typeof e == "function" ? e.call(this.table, t, n.getComponent(), a) : e, this.loadPopup(t, n, e, i, r);
	}
	loadPopup(e, t, n, r, i) {
		var a = !(e instanceof MouseEvent), o, s;
		n instanceof HTMLElement ? o = n : (o = document.createElement("div"), o.innerHTML = n), o.classList.add("tabulator-popup"), o.addEventListener("click", (e) => {
			e.stopPropagation();
		}), a || e.preventDefault(), s = this.popup(o), typeof r == "function" && s.renderCallback(r), e ? s.show(e) : s.show(t.getElement(), i || "center"), s.hideOnBlur(() => {
			this.dispatchExternal("popupClosed", t.getComponent());
		}), this.dispatchExternal("popupOpened", t.getComponent());
	}
};
i(Dt, "moduleName", "popup");
var Ot = class extends l {
	...
	printFullscreen(e, t, n) {
		var r = window.scrollX, i = window.scrollY, a = document.createElement("div"), o = document.createElement("div"), s = this.table.modules.export.generateTable(n === void 0 ? this.table.options.printConfig : n, t === void 0 ? this.table.options.printStyled : t, e || this.table.options.printRowRange, "print"), c, l;
		this.manualBlock = !0, this.element = document.createElement("div"), this.element.classList.add("tabulator-print-fullscreen"), this.table.options.printHeader && (a.classList.add("tabulator-print-header"), c = typeof this.table.options.printHeader == "function" ? this.table.options.printHeader.call(this.table) : this.table.options.printHeader, typeof c == "string" ? a.innerHTML = c : a.appendChild(c), this.element.appendChild(a)), this.element.appendChild(s), this.table.options.printFooter && (o.classList.add("tabulator-print-footer"), l = typeof this.table.options.printFooter == "function" ? this.table.options.printFooter.call(this.table) : this.table.options.printFooter, typeof l == "string" ? o.innerHTML = l : o.appendChild(l), this.element.appendChild(o)), document.body.classList.add("tabulator-print-fullscreen-hide"), document.body.appendChild(this.element), this.table.options.printFormatter && this.table.options.printFormatter(this.element, s), window.print(), this.cleanup(), window.scrollTo(r, i), this.manualBlock = !1;
	}
};
i(Ot, "moduleName", "print");
var kt = class extends l {
	...
	watchData(e) {
		...
		this.currentVersion++, n = this.currentVersion, this.unwatchData(), this.data = e, this.origFuncs.push = e.push, Object.defineProperty(this.data, "push", {
			...
			configurable: !0,
			value: function() {
				var r = Array.from(arguments), i;
				return !t.blocked && n === t.currentVersion && (t.block("data-push"), r.forEach((e) => {
			...
			value: function() {
				var r = Array.from(arguments), i;
				return !t.blocked && n === t.currentVersion && (t.block("data-unshift"), r.forEach((e) => {
			...
			configurable: !0,
			value: function() {
				var r = Array.from(arguments), i = r[0] < 0 ? e.length + r[0] : r[0], a = r[1], o = r[2] ? r.slice(2) : !1, s, c;
				if (!t.blocked && n === t.currentVersion) {
					if (t.block("data-splice"), o && (s = e[i] ? t.table.rowManager.getRowFromDataObject(e[i]) : !1, s ? o.forEach((e) => {
						t.table.rowManager.addRowActual(e, !0, s, !0);
					}) : (o = o.slice().reverse(), o.forEach((e) => {
	...
	watchTreeChildren(e) {
		var t = this, n = e.getData()[this.table.options.dataTreeChildField], r = {};
		n && (r.push = n.push, Object.defineProperty(n, "push", {
			...
			value: () => {
				if (!t.blocked) {
					t.block("tree-push");
					var i = r.push.apply(n, arguments);
			...
			value: () => {
				if (!t.blocked) {
					...
					var i = r.unshift.apply(n, arguments);
			...
			value: () => {
				if (!t.blocked) {
					t.block("tree-splice");
					var i = r.splice.apply(n, arguments);
	...
	watchKey(e, t, n) {
		var r = this, i = Object.getOwnPropertyDescriptor(t, n), a = t[n], o = this.currentVersion;
	...
	unwatchRow(e) {
		var t = e.getData();
		for (var n in t) Object.defineProperty(t, n, { value: t[n] });
	}
	block(e) {
...
var At = class extends l {
	...
	initializeColumn(e, t, n, r) {
		var i = this, a = !1, o = n.definition.resizable, s = {}, c = n.getLastColumn();
		if (e === "header" && (a = n.definition.formatter == "textarea" || n.definition.variableHeight, s = { variableHeight: a }), (o === !0 || o == e) && this._checkResizability(c)) {
			...
			l.addEventListener("mousedown", u), l.addEventListener("touchstart", u, { passive: !0 }), l.addEventListener("dblclick", (e) => {
				var t = c.getWidth();
	...
	resize(e, t) {
		var n = e.clientX === void 0 ? e.touches[0].clientX : e.clientX, r = n - this.startX, i = n - this.latestX, a, o;
		if (this.latestX = n, this.table.rtl && (r = -r, i = -i), a = t.width == t.minWidth || t.width == t.maxWidth, t.setWidth(this.startWidth + r), o = t.width == t.minWidth || t.width == t.maxWidth, i < 0 && (this.nextColumn = this.initialNextColumn), this.table.options.resizableColumnFit && this.nextColumn && !(a && o)) {
			...
			i > 0 && e <= this.nextColumn.minWidth && (this.nextColumn = this.nextColumn.nextColumn()), this.nextColumn && this.nextColumn.setWidth(this.nextColumn.getWidth() - i);
		}
	...
	calcGuidePosition(e, t, n) {
		var r = e.clientX === void 0 ? e.touches[0].clientX : e.clientX, i = n.getBoundingClientRect().x - this.table.element.getBoundingClientRect().x, a = this.table.element.getBoundingClientRect().x, o = t.element.getBoundingClientRect().left - a, s = r - this.startX, c = Math.max(i + s, o + t.minWidth);
	...
	_mouseDown(e, t, n) {
		var r = this, i;
		this.dispatchExternal("columnResizing", t.getComponent()), r.table.options.resizableColumnGuide && (i = document.createElement("span"), i.classList.add("tabulator-col-resize-guide"), r.table.element.appendChild(i), setTimeout(() => {
		...
		e.stopPropagation(), r.startColumn.modules.edit && (r.startColumn.modules.edit.blocked = !0), r.startX = e.clientX === void 0 ? e.touches[0].clientX : e.clientX, r.latestX = r.startX, r.startWidth = t.getWidth(), document.body.addEventListener("mousemove", a), document.body.addEventListener("mouseup", o), n.addEventListener("touchmove", a, { passive: !0 }), n.addEventListener("touchend", o);
	}
};
i(At, "moduleName", "resizeColumns");
var jt = class extends l {
	...
	initializeRow(e) {
		var t = this, n = e.getElement(), r = document.createElement("div");
		...
		r.addEventListener("mousedown", a), r.addEventListener("touchstart", a, { passive: !0 }), i.addEventListener("click", function(e) {
			e.stopPropagation();
		});
		var o = function(n) {
		...
		i.addEventListener("mousedown", o), i.addEventListener("touchstart", o, { passive: !0 }), n.appendChild(r), n.appendChild(i);
	}
	resize(e, t) {
		t.setHeight(this.startHeight + ((e.screenY === void 0 ? e.touches[0].screenY : e.screenY) - this.startY));
	}
	calcGuidePosition(e, t, n) {
		var r = e.screenY === void 0 ? e.touches[0].screenY : e.screenY, i = n.getBoundingClientRect().y - this.table.element.getBoundingClientRect().y, a = this.table.element.getBoundingClientRect().y, o = t.element.getBoundingClientRect().top - a, s = r - this.startY;
		return Math.max(i + s, o);
	}
	_mouseDown(e, t, n) {
		var r = this, i;
		r.dispatchExternal("rowResizing", t.getComponent()), r.table.options.resizableRowGuide && (i = document.createElement("span"), i.classList.add("tabulator-row-resize-guide"), r.table.element.appendChild(i), setTimeout(() => {
		...
		e.stopPropagation(), r.startY = e.screenY === void 0 ? e.touches[0].screenY : e.screenY, r.startHeight = t.getHeight(), document.body.addEventListener("mousemove", a), document.body.addEventListener("mouseup", o), n.addEventListener("touchmove", a, { passive: !0 }), n.addEventListener("touchend", o);
	}
};
i(jt, "moduleName", "resizeRows");
var Mt = class extends l {
	constructor(e) {
	...
	initialize() {
		if (this.table.options.autoResize) {
			var e = this.table, t;
			this.tableHeight = e.element.clientHeight, this.tableWidth = e.element.clientWidth, e.element.parentNode && (this.containerHeight = e.element.parentNode.clientHeight, this.containerWidth = e.element.parentNode.clientWidth), typeof IntersectionObserver < "u" && typeof ResizeObserver < "u" && e.rowManager.getRenderMode() === "virtual" ? (this.initializeVisibilityObserver(), this.autoResize = !0, this.resizeObserver = new ResizeObserver((t) => {
				if (!e.browserMobile || e.browserMobile && (!e.modules.edit || e.modules.edit && !e.modules.edit.currentCell)) {
					var n = Math.floor(t[0].contentRect.height), r = Math.floor(t[0].contentRect.width);
					(this.tableHeight != n || this.tableWidth != r) && (this.tableHeight = n, this.tableWidth = r, e.element.parentNode && (this.containerHeight = e.element.parentNode.clientHeight, this.containerWidth = e.element.parentNode.clientWidth), this.redrawTable());
				}
			}), this.resizeObserver.observe(e.element), t = window.getComputedStyle(e.element), this.table.element.parentNode && !this.table.rowManager.fixedHeight && (t.getPropertyValue("max-height") || t.getPropertyValue("min-height")) && (this.containerObserver = new ResizeObserver((t) => {
				if (!e.browserMobile || e.browserMobile && (!e.modules.edit || e.modules.edit && !e.modules.edit.currentCell)) {
					var n = Math.floor(t[0].contentRect.height), r = Math.floor(t[0].contentRect.width);
					(this.containerHeight != n || this.containerWidth != r) && (this.containerHeight = n, this.containerWidth = r, this.tableHeight = e.element.clientHeight, this.tableWidth = e.element.clientWidth), this.redrawTable();
				}
...
i(Mt, "moduleName", "resizeTable");
function Nt(e, t, n) {
	var r = document.createElement("div"), i = e.getRow()._row.modules.responsiveLayout;
...
var Pt = { format: { formatters: { responsiveCollapse: Nt } } }, U = class extends l {
	constructor(e) {
	...
	initializeResponsivity() {
		var e = [];
		this.mode = this.table.options.responsiveLayout, this.collapseFormatter = this.table.options.responsiveLayoutCollapseFormatter || this.formatCollapsedData, this.collapseStartOpen = this.table.options.responsiveLayoutCollapseStartOpen, this.hiddenColumns = [], this.collapseFormatter && (this.collapseFormatter = this.collapseFormatter.bind(this.table)), this.table.columnManager.columnsByIndex.forEach((t, n) => {
			t.modules.responsive && t.modules.responsive.order && t.modules.responsive.visible && (t.modules.responsive.index = n, e.push(t), !t.visible && this.mode === "collapse" && this.hiddenColumns.push(t));
		}), e = e.reverse(), e = e.sort((e, t) => t.modules.responsive.order - e.modules.responsive.order || t.modules.responsive.index - e.modules.responsive.index), this.columns = e, this.mode === "collapse" && this.generateCollapsedContent();
		for (let e of this.table.columnManager.columnsByIndex) if (e.definition.formatter == "responsiveCollapse") {
	...
	update() {
		for (var e = !0; e;) {
			let t = this.table.modules.layout.getMode() == "fitColumns" ? this.table.columnManager.getFlexBaseWidth() : this.table.columnManager.getWidth(), n = (this.table.options.headerVisible ? this.table.columnManager.element.clientWidth : this.table.element.clientWidth) - t;
			if (n < 0) {
				let t = this.columns[this.index];
				t ? (this.hideColumn(t), this.index++) : e = !1;
			} else {
				let t = this.columns[this.index - 1];
				t && n > 0 && n >= t.getWidth() ? (this.showColumn(t), this.index--) : e = !1;
			}
	...
	generateCollapsedRowData(e) {
		var t = e.getData(), n = [], r;
		return this.hiddenColumns.forEach((i) => {
			var a = i.getFieldValue(t);
			if (i.definition.title && i.field) if (i.modules.format && this.table.options.responsiveLayoutCollapseUseFormatters) {
				r = {
					value: !1,
					data: {},
					getValue: function() {
				...
				n.push({
					...
					value: i.modules.format.formatter.call(this.table.modules.format, r, i.modules.format.params, o)
				});
			} else n.push({
				field: i.field,
				title: i.definition.title,
	...
	formatCollapsedData(e) {
		...
		return e.forEach((e) => {
			var n = document.createElement("tr"), r = document.createElement("td"), i = document.createElement("td"), a, o = document.createElement("strong");
			r.appendChild(o), this.modules.localize.bind("columns|" + e.field, function(t) {
...
i(U, "moduleName", "responsiveLayout"), i(U, "moduleExtensions", Pt);
function Ft(e, t, n) {
	var r = document.createElement("input"), i = !1;
	if (r.type = "checkbox", r.setAttribute("aria-label", "Select Row"), this.table.modExists("selectRow", !0)) if (r.addEventListener("click", (e) => {
		e.stopPropagation();
	}), typeof e.getRow == "function") {
		var a = e.getRow();
		a instanceof E ? (r.addEventListener("change", (e) => {
			this.table.options.selectableRowsRangeMode === "click" && i ? i = !1 : a.toggleSelect();
		}), this.table.options.selectableRowsRangeMode === "click" && r.addEventListener("click", (e) => {
			i = !0, this.table.modules.selectRow.handleComplexRowClick(a._row, e);
		}), r.checked = a.isSelected && a.isSelected(), this.table.modules.selectRow.registerRowSelectCheckbox(a, r)) : r = "";
	} else r.addEventListener("change", (e) => {
...
var It = { format: { formatters: { rowSelection: Ft } } }, W = class extends l {
	constructor(e) {
	...
	initializeRow(e) {
		...
		e.modules.select = { selected: !1 }, r.classList.toggle("tabulator-selectable", n), r.classList.toggle("tabulator-unselectable", !n), t.checkRowSelectability(e) && t.table.options.selectableRows && t.table.options.selectableRows != "highlight" && (t.table.options.selectableRowsRangeMode === "click" ? r.addEventListener("click", this.handleComplexRowClick.bind(this, e)) : (r.addEventListener("click", function(n) {
			...
			if (n.shiftKey) return t.table._clearSelection(), t.selecting = !0, t.selectPrev = [], document.body.addEventListener("mouseup", i), document.body.addEventListener("keyup", i), t.toggleRow(e), !1;
	...
	handleComplexRowClick(e, t) {
		if (t.shiftKey) {
			...
			var n = this.table.rowManager.getDisplayRowIndex(this.lastClickedRow), r = this.table.rowManager.getDisplayRowIndex(e), i = n <= r ? n : r, a = n >= r ? n : r, o = this.table.rowManager.getDisplayRows().slice(0).splice(i, a - i + 1);
			t.ctrlKey || t.metaKey ? (o.forEach((t) => {
				t !== this.lastClickedRow && (this.table.options.selectableRows !== !0 && !this.isRowSelected(e) ? this.selectedRows.length < this.table.options.selectableRows && this.toggleRow(t) : this.toggleRow(t));
	...
	selectRows(e) {
		...
		Array.isArray(n) ? n.length && (n.forEach((e) => {
			r = this._selectRow(e, !0, !0), r && t.push(r);
		}), this._rowSelectionChanged(!1, t)) : n && this._selectRow(n, !1, !0);
	}
	_selectRow(e, t, n) {
		if (!isNaN(this.table.options.selectableRows) && this.table.options.selectableRows !== !0 && !n && this.selectedRows.length >= this.table.options.selectableRows) if (this.table.options.selectableRowsRollingSelection) this._deselectRow(this.selectedRows[0]);
		else return !1;
	...
	deselectRows(e, t) {
		...
		Array.isArray(r) ? r.length && (r.forEach((e) => {
			i = this._deselectRow(e, !0, !0), i && n.push(i);
		}), this._rowSelectionChanged(t, [], n)) : r && this._deselectRow(r, t, !0);
	}
	_deselectRow(e, t) {
		var n = this, r = n.table.rowManager.findRow(e), i, a;
		if (r) {
	...
	_rowSelectionChanged(e, t = [], n = []) {
		this.headerCheckboxElement && (this.selectedRows.length === 0 ? (this.headerCheckboxElement.checked = !1, this.headerCheckboxElement.indeterminate = !1) : this.table.rowManager.rows.length === this.selectedRows.length ? (this.headerCheckboxElement.checked = !0, this.headerCheckboxElement.indeterminate = !1) : (this.headerCheckboxElement.indeterminate = !0, this.headerCheckboxElement.checked = !1)), e || (Array.isArray(t) || (t = [t]), t = t.map((e) => e.getComponent()), Array.isArray(n) || (n = [n]), n = n.map((e) => e.getComponent()), this.dispatchExternal("rowSelectionChanged", this.getSelectedData(), this.getSelectedRows(), t, n));
	}
	...
	childRowSelection(e, t) {
		...
		if (t) for (let e of n) this._selectRow(e, !0);
		else for (let e of n) this._deselectRow(e, !0);
	}
};
i(W, "moduleName", "selectRow"), i(W, "moduleExtensions", It);
var Lt = class {
	constructor(e) {
		return this._range = e, new Proxy(this, { get: function(e, t, n) {
	...
	setEndBound(e) {
		var t = this._getTableRows().length, n, r, i;
	...
	getData() {
		var e = [], t = this.getRows(), n = this.getColumns();
		return t.forEach((t) => {
			var r = t.getData(), i = {};
			n.forEach((e) => {
				i[e.field] = r[e.field];
	...
	getCells(e, t) {
		var n = [], r = this.getRows(), i = this.getColumns();
		return e ? n = r.map((e) => {
			var n = [];
	...
	getComponent() {
		return this.component || (this.component = new Lt(this)), this.component;
	}
	destroy(e) {
	...
	clipboard: {
		pasteActions: { range: function(e) {
			var t = [], n = this.table.modules.selectRange.activeRange, r = !1, i, a, o, s, c = e.length;
			return n && (i = n.getBounds(), a = i.start, i.start === i.end && (r = !0), a && (t = this.table.rowManager.activeRows.slice(), o = t.indexOf(a.row), s = r ? e.length : t.indexOf(i.end.row) - o + 1, o > -1 && (this.table.blockRedraw(), t = t.slice(o, o + s), t.forEach((t, n) => {
				t.updateData(e[n % c]);
			}), this.table.restoreRedraw()))), t;
		} },
		pasteParsers: { range: function(e) {
			var t = [], n = [], r = this.table.modules.selectRange.activeRange, i = !1, a, o, s, c, l;
			return r && (a = r.getBounds(), o = a.start, a.start === a.end && (i = !0), o && (e = e.split("\n"), e.forEach(function(e) {
				t.push(e.split("	"));
			}), t.length && (c = this.table.columnManager.getVisibleColumnsByIndex(), l = c.indexOf(o.column), l > -1))) ? (s = i ? t[0].length : c.indexOf(a.end.column) - l + 1, c = c.slice(l, l + s), t.forEach((e) => {
				var t = {}, r = e.length;
	...
	rowGetRanges(e) {
		return this.ranges.filter((t) => t.occupiesRow(e)).map((e) => e.getComponent());
	}
	colGetRanges(e) {
		return this.ranges.filter((t) => t.occupiesColumn(e)).map((e) => e.getComponent());
	}
	_handleMouseUp(e) {
	...
	handleColumnResized(e) {
		var t;
		this.selecting !== "column" && this.selecting !== "all" || (t = this.ranges.some((t) => t.occupiesColumn(e)), t && this.ranges.forEach((t) => {
	...
	renderCell(e) {
		var t = e.getElement(), n = this.ranges.findIndex((t) => t.occupies(e));
	...
	keyNavigate(e, t) {
		if (this.options("selectableRangeBlurEditOnNavigate") && this.chain("edit-check-editing")) if (e === "next" || e === "prev") this.dispatch("edit-cancel-cell");
		else return !1;
		e === "prev" ? e = "left" : e === "next" && (e = "right"), this.navigate(!1, !1, e) && t.preventDefault();
	}
	keyNavigateRange(e, t, n, r) {
		this.navigate(n, r, t) && e.preventDefault();
	}
	navigate(e, t, n) {
		var r = !1, i, a, o, s, c, l, u, d, f, p, m;
		if (this.table.modules.edit && this.table.modules.edit.currentCell) return !1;
		if (this.ranges.length > 1 && (this.ranges = this.ranges.filter((e) => e === this.activeRange ? (e.setEnd(e.start.row, e.start.col), !0) : (e.destroy(), !1))), i = this.activeRange, o = {
			top: i.top,
			bottom: i.bottom,
			left: i.left,
			right: i.right
	...
	findJumpCellLeft(e, t) {
		var n = this.getRowByRangePos(e), r = this.getTableColumns(), i = this.isEmpty(n.getData()[r[t].getField()]), a = r[t - 1] ? this.isEmpty(n.getData()[r[t - 1].getField()]) : !1, o = this.rowHeader ? r.slice(1, t) : r.slice(0, t), s = this.findJumpCol(n, o, !0, i, a);
		return s ? s.getPosition() - 1 : t;
	}
	findJumpCellRight(e, t) {
		var n = this.getRowByRangePos(e), r = this.getTableColumns(), i = this.isEmpty(n.getData()[r[t].getField()]), a = r[t + 1] ? this.isEmpty(n.getData()[r[t + 1].getField()]) : !1, o = this.findJumpCol(n, r.slice(t + 1, r.length), !1, i, a);
		return o ? o.getPosition() - 1 : t;
	}
	findJumpCellUp(e, t) {
		var n = this.getColumnByRangePos(t), r = this.getTableRows(), i = this.isEmpty(r[e].getData()[n.getField()]), a = r[e - 1] ? this.isEmpty(r[e - 1].getData()[n.getField()]) : !1, o = this.findJumpRow(n, r.slice(0, e), !0, i, a);
		return o ? o.position - 1 : e;
	}
	findJumpCellDown(e, t) {
		var n = this.getColumnByRangePos(t), r = this.getTableRows(), i = this.isEmpty(r[e].getData()[n.getField()]), a = r[e + 1] ? this.isEmpty(r[e + 1].getData()[n.getField()]) : !1, o = this.findJumpRow(n, r.slice(e + 1, r.length), !1, i, a);
		return o ? o.position - 1 : e;
	}
	newSelection(e, t) {
		var n;
	...
	autoScroll(e, t, n) {
		var r = this.table.rowManager.element, i, a, o, s;
	...
	layoutElement(e) {
		(e ? this.table.rowManager.getVisibleRows(!0) : this.table.rowManager.getRows()).forEach((e) => {
			e.type === "row" && (this.layoutRow(e), e.cells.forEach((e) => this.renderCell(e)));
		}), this.getTableColumns().forEach((e) => {
			this.layoutColumn(e);
		}), this.layoutRanges();
	}
	layoutRow(e) {
		var t = e.getElement(), n = !1, r = this.ranges.some((t) => t.occupiesRow(e));
	...
	layoutColumn(e) {
		var t = e.getElement(), n = !1, r = this.ranges.some((t) => t.occupiesColumn(e));
	...
	layoutRanges() {
		var e, t, n;
		this.table.initialized && (e = this.getActiveCell(), e && (t = e.getElement(), n = e.row.getElement(), this.table.rtl ? this.activeRangeCellElement.style.right = n.offsetWidth - t.offsetLeft - t.offsetWidth + "px" : this.activeRangeCellElement.style.left = n.offsetLeft + t.offsetLeft + "px", this.activeRangeCellElement.style.top = n.offsetTop + "px", this.activeRangeCellElement.style.width = t.offsetWidth + "px", this.activeRangeCellElement.style.height = n.offsetHeight + "px", this.ranges.forEach((e) => e.layout()), this.overlay.style.visibility = "visible"));
	}
	getCell(e, t) {
		var n;
		return t < 0 && (t = this.getTableColumns().length + t, t < 0) ? null : (e < 0 && (e = this.getTableRows().length + e), n = this.table.rowManager.getRowFromPosition(e + 1), n ? n.getCells(!1, !0).filter((e) => e.column.visible)[t] : null);
	}
	getActiveCell() {
	...
	addRange(e, t) {
		var n;
		return this.maxRanges !== !0 && this.ranges.length >= this.maxRanges && this.ranges.shift().destroy(), n = new Rt(this.table, this, e, t), this.activeRange = n, this.ranges.push(n), this.rangeContainer.appendChild(n.element), n;
	}
	resetRanges() {
		var e, t, n;
		return this.ranges.forEach((e) => e.destroy()), this.ranges = [], e = this.addRange(), this.table.rowManager.activeRows.length && (n = this.table.rowManager.activeRows[0].cells.filter((e) => e.column.visible), t = n[this.rowHeader ? 1 : 0], t && (e.setBounds(t), this.options("selectableRangeAutoFocus") && this.initializeFocus(t))), e;
	}
	tableDestroyed() {
...
i(G, "moduleName", "selectRange"), i(G, "moduleInitOrder", 1), i(G, "moduleExtensions", zt);
function Bt(e, t, n, r, i, a, o) {
	var s = o.alignEmptyValues, c = o.decimalSeparator, l = o.thousandSeparator, u = 0;
	if (e = String(e), t = String(t), l && (e = e.split(l).join(""), t = t.split(l).join("")), c && (e = e.split(c).join("."), t = t.split(c).join(".")), e = parseFloat(e), t = parseFloat(t), isNaN(e)) u = isNaN(t) ? 0 : -1;
	else if (isNaN(t)) u = 1;
	else return e - t;
	return (s === "top" && a === "desc" || s === "bottom" && a === "asc") && (u *= -1), u;
}
function Vt(e, t, n, r, i, a, o) {
	var s = o.alignEmptyValues, c = 0, l;
	if (!e) c = t ? -1 : 0;
	else if (!t) c = 1;
	else {
...
function K(e, t, n, r, i, a, o) {
	var s = this.table.dependencyRegistry.lookup(["luxon", "DateTime"], "DateTime"), c = o.format || "dd/MM/yyyy HH:mm:ss", l = o.alignEmptyValues, u = 0;
	if (s !== void 0) {
		if (s.isDateTime(e) || (e = c === "iso" ? s.fromISO(String(e)) : s.fromFormat(String(e), c)), s.isDateTime(t) || (t = c === "iso" ? s.fromISO(String(t)) : s.fromFormat(String(t), c)), !e.isValid) u = t.isValid ? -1 : 0;
		else if (!t.isValid) u = 1;
		else return e - t;
...
function Ht(e, t, n, r, i, a, o) {
	return o.format || (o.format = "dd/MM/yyyy"), K.call(this, e, t, n, r, i, a, o);
}
function Ut(e, t, n, r, i, a, o) {
	return o.format || (o.format = "HH:mm"), K.call(this, e, t, n, r, i, a, o);
}
function Wt(e, t, n, r, i, a, o) {
	return (e === !0 || e === "true" || e === "True" || e === 1 ? 1 : 0) - (t === !0 || t === "true" || t === "True" || t === 1 ? 1 : 0);
}
function Gt(e, t, n, r, i, a, o) {
	var c = o.type || "length", l = o.alignEmptyValues, u = 0, d = this.table, f;
	o.valueMap && (f = typeof o.valueMap == "string" ? function(e) {
		return e.map((e) => s.retrieveNestedData(d.options.nestedFieldSeparator, o.valueMap, e));
	} : o.valueMap);
	function p(e) {
		var t;
		switch (f && (e = f(e)), c) {
	...
	if (!Array.isArray(e)) u = Array.isArray(t) ? -1 : 0;
	else if (!Array.isArray(t)) u = 1;
	else if (c === "string") return String(p(e)).toLowerCase().localeCompare(String(p(t)).toLowerCase());
	else return p(t) - p(e);
	return (l === "top" && a === "desc" || l === "bottom" && a === "asc") && (u *= -1), u;
}
...
function qt(e, t, n, r, i, a, o) {
	var s, c, l, u, d = 0, f, p = /(\d+)|(\D+)/g, m = /\d/, h = o.alignEmptyValues, g = 0;
	if (!e && e !== 0) g = !t && t !== 0 ? 0 : -1;
	else if (!t && t !== 0) g = 1;
	else {
		if (isFinite(e) && isFinite(t)) return e - t;
...
var Jt = {
		...
		if (t.modules.sort = {
			...
			switch (this.table.options.headerSortElement) {
				...
				case "object":
					...
					break;
				default: i.innerHTML = this.table.options.headerSortElement;
			}
			t.titleHolderElement.appendChild(i), t.modules.sort.element = i, this.setColumnHeaderSortIcon(t, "none"), this.table.options.headerSortClickElement === "icon" && i.addEventListener("mousedown", (e) => {
				e.stopPropagation();
			}), (this.table.options.headerSortClickElement === "icon" ? i : r).addEventListener("click", (e) => {
				var n = "", r = [], i = !1;
				if (t.modules.sort) {
					if (t.modules.sort.tristate) n = t.modules.sort.dir == "none" ? t.modules.sort.startingDir : t.modules.sort.dir == t.modules.sort.startingDir ? t.modules.sort.dir == "asc" ? "desc" : "asc" : "none";
						...
						case "desc":
							n = "asc";
							break;
						default: n = t.modules.sort.startingDir;
					}
					this.table.options.columnHeaderSortMulti && (e.shiftKey || e.ctrlKey) ? (r = this.getSort(), i = r.findIndex((e) => e.field === t.getField()), i > -1 ? (r[i].dir = n, i = r.splice(i, 1)[0], n != "none" && r.push(i)) : n != "none" && r.push({
						column: t,
						dir: n
					}), this.setSort(r)) : n == "none" ? this.clear() : this.setSort(t, n), this.refreshSort();
				}
			});
		}
	}
	...
	findSorter(t) {
		var n = this.table.rowManager.activeRows[0], r = "string", i, a;
		if (n && (n = n.getData(), i = t.getField(), i)) switch (a = t.getFieldValue(n), typeof a) {
			case "undefined":
				r = "string";
				break;
			case "boolean":
	...
	sort(e, t) {
		var n = this, r = this.table.options.sortOrderReverse ? n.sortList.slice().reverse() : n.sortList, i = [], a = [];
		return this.subscribedExternal("dataSorting") && this.dispatchExternal("dataSorting", n.getSort()), t || n.clearColumnHeaders(), this.table.options.sortMode === "remote" ? t || r.forEach(function(e, t) {
			...
			var a;
			e.column && (a = e.column.modules.sort, a && (a.sorter || (a.sorter = n.findSorter(e.column)), e.params = typeof a.params == "function" ? a.params(e.column.getComponent(), e.dir) : a.params, i.push(e)), t || n.setColumnHeader(e.column, e.dir));
		}), i.length && n._sortItems(e, i)), this.subscribedExternal("dataSorted") && (e.forEach((e) => {
			a.push(e.getComponent());
		}), this.dispatchExternal("dataSorted", n.getSort(), a)), e;
	}
	clearColumnHeaders() {
	...
	setColumnHeaderSortIcon(e, t) {
		var n = e.modules.sort.element, r;
		if (e.definition.headerSort && typeof this.table.options.headerSortElement == "function") {
			for (; n.firstChild;) n.removeChild(n.firstChild);
			r = this.table.options.headerSortElement.call(this.table, e.getComponent(), t), typeof r == "object" ? n.appendChild(r) : n.innerHTML = r;
		}
	}
	_sortItems(e, t) {
		var n = t.length - 1;
		e.sort((e, r) => {
			for (var i, a = n; a >= 0; a--) {
				let n = t[a];
				if (i = this._sortRow(e, r, n.column, n.dir, n.params), i !== 0) break;
			}
			return i;
		});
	}
	_sortRow(e, t, n, r, i) {
		var a, o, s = r == "asc" ? e : t, c = r == "asc" ? t : e;
		return e = n.getFieldValue(s.getData()), t = n.getFieldValue(c.getData()), e = e === void 0 ? "" : e, t = t === void 0 ? "" : t, a = s.getComponent(), o = c.getComponent(), n.modules.sort.sorter.call(this, e, t, a, o, n.getComponent(), r, i);
	}
};
i(q, "moduleName", "sort"), i(q, "sorters", Jt);
var Yt = class {
	constructor(e, t) {
	...
	constructor(e) {
		return this._sheet = e, new Proxy(this, { get: function(e, t, n) {
	...
	initializeRows() {
		...
		this.grid.setRowCount(this.rowCount), e = this.grid.genRows(this.data), this.rowDefs = [], e.forEach((e, t) => {
			var n = { _id: e }, r = this.data[t];
			r && r.forEach((e, t) => {
				var r = this.columnFields[t];
				r && (n[r] = e);
			}), this.rowDefs.push(n);
		});
	}
	...
	getData(e) {
		...
		return this.rowDefs.forEach((e) => {
			var n = [];
			this.columnFields.forEach((t) => {
				n.push(e[t]);
			}), t.push(n);
		}), !e && !this.options("spreadsheetOutputFull") && (n = t.map((e) => e.findLastIndex((e) => e !== void 0) + 1), r = Math.max(...n), i = n.findLastIndex((e) => e > 0) + 1, t = t.slice(0, i), t = t.map((e) => e.slice(0, r))), t;
	}
	setData(e) {
	...
	newSheet(e = {}) {
		var t;
		return e.rows || (e.rows = this.options("spreadsheetRows")), e.columns || (e.columns = this.options("spreadsheetColumns")), t = new Zt(this, e), this.sheets.push(t), this.element && this.element.appendChild(t.element), t;
	}
	removeSheet(e) {
		var t = this.sheets.indexOf(e), n;
	...
	lookupSheet(e) {
		return e ? e instanceof Zt ? e : e instanceof Xt ? e._sheet : this.sheets.find((t) => t.key === e) || !1 : this.activeSheet;
	}
	setSheets(e) {
...
var $t = class extends l {
	...
	loadTooltip(e, t, n) {
		...
		typeof n == "function" && (n = n(e, t.getComponent(), o)), n instanceof HTMLElement ? r = n : (r = document.createElement("div"), n === !0 && (t instanceof w ? n = t.value : t.definition.field ? this.langBind("columns|" + t.definition.field, (e) => {
			r.innerHTML = n = e || t.definition.title;
		}) : n = t.definition.title), r.innerHTML = n), (n || n === 0 || n === !1) && (r.classList.add("tabulator-tooltip"), r.addEventListener("mousemove", (e) => e.preventDefault()), this.popupInstance = this.popup(r), typeof i == "function" && this.popupInstance.renderCallback(i), a = this.popupInstance.containerEventCoords(e), this.popupInstance.show(a.x + 15, a.y + 15).hideOnBlur(() => {
...
var en = {
	...
	alphanumeric: function(e, t, n) {
		return t === "" || t == null ? !0 : (/* @__PURE__ */ new RegExp(/^[a-z0-9]+$/i)).test(t);
	},
	max: function(e, t, n) {
	...
	in: function(e, t, n) {
		return t === "" || t == null ? !0 : (typeof n == "string" && (n = n.split("|")), n.indexOf(t) > -1);
	},
	...
	unique: function(e, t, n) {
		...
		var r = !0, i = e.getData(), a = e.getColumn()._getSelf();
	...
	editValidate(e, t, n) {
		var r = this.table.options.validationMode === "manual" ? !0 : this.validate(e.column.modules.validate, e, t);
		return r !== !0 && setTimeout(() => {
			e.getElement().classList.add("tabulator-validation-fail"), this.dispatchExternal("validationFailed", e.getComponent(), t, r);
		}), r;
	}
	editorClear(e, t) {
	...
	columnValidate(e) {
		...
		return e.cells.forEach((e) => {
			this.cellValidate(e) !== !0 && t.push(e.getComponent());
		}), t.length ? t : !0;
	}
	rowValidate(e) {
		var t = [];
	...
	initializeColumnCheck(e) {
		e.definition.validator !== void 0 && this.initializeColumn(e);
	}
	initializeColumn(e) {
		var t = this, n = [], r;
		e.definition.validator && (Array.isArray(e.definition.validator) ? e.definition.validator.forEach((e) => {
			r = t._extractValidator(e), r && n.push(r);
		}) : (r = this._extractValidator(e.definition.validator), r && n.push(r)), e.modules.validate = n.length ? n : !1);
	}
	_extractValidator(e) {
		var t, n, r;
		switch (typeof e) {
			case "string": return r = e.indexOf(":"), r > -1 ? (t = e.substring(0, r), n = e.substring(r + 1)) : t = e, this._buildValidator(t, n);
			case "function": return this._buildValidator(e);
			case "object": return this._buildValidator(e.type, e.parameters);
		}
	}
	_buildValidator(t, n) {
		var r = typeof t == "function" ? t : e.validators[t];
		return r ? {
			type: typeof t == "function" ? "function" : t,
			func: r,
			params: n
		} : (console.warn("Validator Setup Error - No matching validator found:", t), !1);
	}
	validate(e, t, n) {
		var r = this, i = [], a = this.invalidCells.indexOf(t);
		return e && e.forEach((e) => {
			e.func.call(r, t.getComponent(), n, e.params) || i.push({
				type: e.type,
				parameters: e.params
			});
...
i(J, "moduleName", "validate"), i(J, "validators", en);
var Y = /* @__PURE__ */ Object.freeze({
	...
	FilterModule: je,
	FormatModule: P,
	FrozenColumnsModule: tt,
	FrozenRowsModule: nt,
	GroupRowsModule: it,
	HistoryModule: I,
	HtmlTableImportModule: ct,
	ImportModule: L,
	InteractionModule: mt,
	KeybindingsModule: R,
	MenuModule: _t,
	MoveColumnsModule: vt,
	MoveRowsModule: z,
	MutatorModule: B,
	PageModule: V,
	PersistenceModule: H,
	PopupModule: Dt,
	PrintModule: Ot,
	ReactiveDataModule: kt,
	ResizeColumnsModule: At,
	ResizeRowsModule: jt,
	ResizeTableModule: Mt,
	ResponsiveLayoutModule: U,
	SelectRangeModule: G,
	SelectRowModule: W,
	SortModule: q,
	SpreadsheetModule: Qt,
	TooltipModule: $t,
	ValidateModule: J
}), tn = {
	...
	generate(e, t = {}) {
		var n = Object.assign({}, this.registeredDefaults), r = this.table.options.debugInvalidOptions || t.debugInvalidOptions === !0;
		Object.assign(n, e);
		for (let e in t) n.hasOwnProperty(e) || (r && console.warn("Invalid " + this.msgType + " option:", e), n[e] = t.key);
		for (let e in n) e in t ? n[e] = t[e] : Array.isArray(n[e]) ? n[e] = Object.assign([], n[e]) : typeof n[e] == "object" && n[e] !== null ? n[e] = Object.assign({}, n[e]) : n[e] === void 0 && delete n[e];
		return n;
	}
}, X = class extends o {
	constructor(e) {
	...
	scrollToRowPosition(e, t, n) {
		var r = this.rows().indexOf(e), i = e.getElement(), a = 0;
		return new Promise((o, c) => {
			if (r > -1) {
				if (n === void 0 && (n = this.table.options.scrollToRowIfVisible), !n && s.elVisible(i) && (a = s.elOffset(i).top - s.elOffset(this.elementVertical).top, a > 0 && a < this.elementVertical.clientHeight - i.offsetHeight)) return o(), !1;
				switch (t === void 0 && (t = this.table.options.scrollToRowPosition), t === "nearest" && (t = this.scrollToRowNearestTop(e) ? "top" : "bottom"), this.scrollToRow(e), t) {
					case "middle":
					case "center":
						this.elementVertical.scrollHeight - this.elementVertical.scrollTop == this.elementVertical.clientHeight ? this.elementVertical.scrollTop = this.elementVertical.scrollTop + (i.offsetTop - this.elementVertical.scrollTop) - (this.elementVertical.scrollHeight - i.offsetTop) / 2 : this.elementVertical.scrollTop = this.elementVertical.scrollTop - this.elementVertical.clientHeight / 2;
						break;
					case "bottom":
						this.elementVertical.scrollHeight - this.elementVertical.scrollTop == this.elementVertical.clientHeight ? this.elementVertical.scrollTop = this.elementVertical.scrollTop - (this.elementVertical.scrollHeight - i.offsetTop) + i.offsetHeight : this.elementVertical.scrollTop = this.elementVertical.scrollTop - this.elementVertical.clientHeight + i.offsetHeight;
						break;
					case "top":
						this.elementVertical.scrollTop = i.offsetTop;
						break;
				}
				o();
			} else console.warn("Scroll Error - Row not visible"), c("Scroll Error - Row not visible");
		});
	}
}, rn = class extends X {
	constructor(e) {
	...
	renderRowCells(e, t) {
		...
		}), e.element.appendChild(n), t || e.cells.forEach((e) => {
			e.cellRendered();
		});
	}
	reinitializeColumnWidths(e) {
	...
	rerenderColumns(e, t) {
		...
		e && !this.initialized || (this.clear(), this.calcWindowBuffer(), this.scrollLeft = this.elementVertical.scrollLeft, this.vDomScrollPosLeft = this.scrollLeft - this.windowBuffer, this.vDomScrollPosRight = this.scrollLeft + this.elementVertical.clientWidth + this.windowBuffer, this.table.columnManager.columnsByIndex.forEach((e) => {
			var t = {}, n;
			e.visible && (e.modules.frozen || (n = e.getWidth(), t.leftPos = r, t.rightPos = r + n, t.width = n, this.isFitData && (t.fitDataCheck = e.modules.vdomHoz ? e.modules.vdomHoz.fitDataCheck : !0), r + n > this.vDomScrollPosLeft && r < this.vDomScrollPosRight ? (this.leftCol == -1 && (this.leftCol = this.columns.length, this.vDomPadLeft = r), this.rightCol = this.columns.length) : this.leftCol !== -1 && (this.vDomPadRight += n), this.columns.push(e), e.modules.vdomHoz = t, r += n));
		...
		if (this.isFitData) {
			if (this.table.columnManager.columnsByIndex.forEach((t) => {
				...
				for (let e = 0; e < t.cells.length; e++) {
					let r = t.cells[e];
					n.appendChild(r.getElement()), r.column.reinitializeWidth();
				}
	...
	reinitChanged(e) {
		var t = !0;
		return e.cols.length !== this.columns.length || e.leftCol !== this.leftCol || e.rightCol !== this.rightCol ? !0 : (e.cols.forEach((e, n) => {
			e !== this.columns[n] && (t = !1);
		}), !t);
	}
	reinitializeRows() {
	...
	colPositionAdjust(e, t, n) {
		for (let r = e; r < t; r++) {
			let e = this.columns[r];
			e.modules.vdomHoz.leftPos += n, e.modules.vdomHoz.rightPos += n;
		}
	}
	addColRight() {
		for (var e = !1, t = !0; t;) {
			let n = this.columns[this.rightCol + 1];
			n && n.modules.vdomHoz.leftPos <= this.vDomScrollPosRight ? (e = !0, this.getVisibleRows().forEach((e) => {
				if (e.type !== "group") {
					var t = e.getCell(n);
					e.getElement().insertBefore(t.getElement(), e.getCell(this.columns[this.rightCol]).getElement().nextSibling), t.cellRendered();
				}
			}), this.fitDataColActualWidthCheck(n), this.rightCol++, this.getVisibleRows().forEach((e) => {
				e.type !== "group" && (e.modules.vdomHoz.rightCol = this.rightCol);
			}), this.rightCol >= this.columns.length - 1 ? this.vDomPadRight = 0 : this.vDomPadRight -= n.getWidth()) : t = !1;
		}
		e && (this.tableElement.style.paddingRight = this.vDomPadRight + "px");
	}
	addColLeft() {
		for (var e = !1, t = !0; t;) {
			let n = this.columns[this.leftCol - 1];
			if (n) if (n.modules.vdomHoz.rightPos >= this.vDomScrollPosLeft) {
				e = !0, this.getVisibleRows().forEach((e) => {
					...
					e.type !== "group" && (e.modules.vdomHoz.leftCol = this.leftCol);
				}), this.leftCol <= 0 ? this.vDomPadLeft = 0 : this.vDomPadLeft -= n.getWidth();
				let t = this.fitDataColActualWidthCheck(n);
	...
	removeColRight() {
		for (var e = !1, t = !0; t;) {
			let n = this.columns[this.rightCol];
			n && n.modules.vdomHoz.leftPos > this.vDomScrollPosRight ? (e = !0, this.getVisibleRows().forEach((e) => {
				if (e.type !== "group") {
					var t = e.getCell(n);
					try {
			...
			}), this.vDomPadRight += n.getWidth(), this.rightCol--, this.getVisibleRows().forEach((e) => {
				e.type !== "group" && (e.modules.vdomHoz.rightCol = this.rightCol);
			})) : t = !1;
		}
		e && (this.tableElement.style.paddingRight = this.vDomPadRight + "px");
	...
	removeColLeft() {
		for (var e = !1, t = !0; t;) {
			let n = this.columns[this.leftCol];
			n && n.modules.vdomHoz.rightPos < this.vDomScrollPosLeft ? (e = !0, this.getVisibleRows().forEach((e) => {
				if (e.type !== "group") {
					var t = e.getCell(n);
					try {
						e.getElement().removeChild(t.getElement());
			...
			}), this.vDomPadLeft += n.getWidth(), this.leftCol++, this.getVisibleRows().forEach((e) => {
				e.type !== "group" && (e.modules.vdomHoz.leftCol = this.leftCol);
			})) : t = !1;
		}
		e && (this.tableElement.style.paddingLeft = this.vDomPadLeft + "px");
	...
	constructor(e) {
		super(e), this.blockHozScrollEvent = !1, this.headersElement = null, this.contentsElement = null, this.rowHeader = null, this.element = null, this.columns = [], this.columnsByIndex = [], this.columnsByField = {}, this.scrollLeft = 0, this.optionsList = new nn(this.table, "column definition", re), this.redrawBlock = !1, this.redrawBlockUpdate = null, this.renderer = null;
	}
	initialize() {
	...
	initializeRenderer() {
		...
		e = typeof this.table.options.renderHorizontal == "string" ? t[this.table.options.renderHorizontal] : this.table.options.renderHorizontal, e ? (this.renderer = new e(this.table, this.element, this.tableElement), this.renderer.initialize()) : console.error("Unable to find matching renderer:", this.table.options.renderHorizontal);
	}
	...
	generateColumnsFromRowData(e) {
		var t = [], n = {}, r = this.table.options.autoColumns === "full" ? e : [e[0]], i = this.table.options.autoColumnsDefinitions;
		if (e && e.length) {
			if (r.forEach((e) => {
				Object.keys(e).forEach((r, i) => {
					let a = e[r], o;
					n[r] ? n[r] !== !0 && a !== void 0 && (n[r].sorter = this.calculateSorterFromValue(a), n[r] = !0) : (o = {
						field: r,
						title: r,
						sorter: this.calculateSorterFromValue(a)
				...
				case "function":
					...
					break;
				case "object":
					Array.isArray(i) ? t.forEach((e) => {
						var t = i.find((t) => t.field === e.field);
						t && Object.assign(e, t);
					}) : t.forEach((e) => {
	...
	setColumns(e, t) {
		...
		this.columns = [], this.columnsByIndex = [], this.columnsByField = {}, this.dispatch("columns-loading"), this.dispatchExternal("columnsLoading"), this.table.options.rowHeader && (this.rowHeader = new T(this.table.options.rowHeader === !0 ? {} : this.table.options.rowHeader, this, !0), this.columns.push(this.rowHeader), this.headersElement.appendChild(this.rowHeader.getElement()), this.rowHeader.columnRendered()), e.forEach((e, t) => {
			this._addColumn(e);
	...
	_addColumn(e, t, n) {
		var r = new T(e, this), i = r.getElement(), a = n && this.findColumnIndex(n);
		if (t && this.rowHeader && (!n || n === this.rowHeader) && (t = !1, n = this.rowHeader, a = 0), n && a > -1) {
			var o = n.getTopColumn(), s = this.columns.indexOf(o), c = o.getElement();
	...
	findColumn(e) {
		...
		if (typeof e == "object") {
			...
			if (typeof HTMLElement < "u" && e instanceof HTMLElement) return t = [], this.columns.forEach((e) => {
				t.push(e), t = t.concat(e.getColumns(!0));
	...
	getColumnsByFieldRoot(e) {
		var t = [];
		return Object.keys(this.columnsByField).forEach((n) => {
			(this.table.options.nestedFieldSeparator ? n.split(this.table.options.nestedFieldSeparator)[0] : n) === e && t.push(this.columnsByField[n]);
		}), t;
	}
	getColumnByIndex(e) {
	...
	traverse(e) {
		this.columnsByIndex.forEach((t, n) => {
			e(t, n);
		});
	}
	getDefinitions(e) {
		var t = [];
		return this.columnsByIndex.forEach((n) => {
	...
	_moveColumnInArray(e, t, n, r, i) {
		var a = e.indexOf(t), o, s = [];
		a > -1 && (e.splice(a, 1), o = e.indexOf(n), o > -1 ? r && (o += 1) : o = a, e.splice(o, 0, t), i && (s = this.chain("column-moving-rows", [
			t,
			n,
			r
		], null, []) || [], s = s.concat(this.table.rowManager.rows), s.forEach(function(e) {
			if (e.cells.length) {
	...
	scrollToColumn(e, t, n) {
		var r = 0, i = e.getLeftOffset(), a = 0, o = e.getElement();
		return new Promise((s, c) => {
			if (t === void 0 && (t = this.table.options.scrollToColumnPosition), n === void 0 && (n = this.table.options.scrollToColumnIfVisible), e.visible) {
				switch (t) {
					case "middle":
					case "center":
				...
				if (!n && i > 0 && i + o.offsetWidth < this.element.clientWidth) return !1;
				r = i + a, r = Math.max(Math.min(r, this.table.rowManager.element.scrollWidth - this.table.rowManager.element.clientWidth), 0), this.table.rowManager.scrollHorizontal(r), this.scrollHorizontal(r), s();
	...
	getFlexBaseWidth() {
		...
		return this.table.rowManager.element.scrollHeight > this.table.rowManager.element.clientHeight && (e -= this.table.rowManager.element.offsetWidth - this.table.rowManager.element.clientWidth), this.columnsByIndex.forEach(function(n) {
			var r, i, a;
			n.visible && (r = n.definition.width || 0, i = parseInt(n.minWidth), a = typeof r == "string" ? r.indexOf("%") > -1 ? e / 100 * parseInt(r) : parseInt(r) : r, t += a > i ? a : i);
		}), t;
	}
	addColumn(e, t, n) {
		return new Promise((r, i) => {
			var a = this._addColumn(e, t, n);
			this._reIndexColumns(), this.dispatch("column-add", e, t, n), this.layoutMode() != "fitColumns" && a.reinitializeWidth(), this.redraw(!0), this.table.rowManager.reinitialize(), this.rerenderColumns(), r(a);
		});
	}
	deregisterColumn(e) {
		var t = e.getField(), n;
	...
	redraw(e) {
		s.elVisible(this.element) && this.verticalAlignHeaders(), e && (this.table.rowManager.resetScroll(), this.table.rowManager.reinitialize()), this.confirm("table-redrawing", e) || this.layoutRefresh(e), this.dispatch("table-redraw", e), this.table.footerManager.redraw();
	}
}, sn = class extends X {
	constructor(e) {
	...
	renderRows() {
		var e = this.tableElement, t = !0, n = document.createDocumentFragment(), r = this.rows();
		r.forEach((e, r) => {
			this.styleRow(e, r), e.initialize(!1, !0), e.type !== "group" && (t = !1), n.appendChild(e.getElement());
		}), e.appendChild(n), r.forEach((e) => {
	...
	scrollToRowNearestTop(e) {
		var t = s.elOffset(e.getElement()).top;
	...
	scrollToRow(e) {
		var t = e.getElement();
		this.elementVertical.scrollTop = s.elOffset(t).top - s.elOffset(this.elementVertical).top + this.elementVertical.scrollTop;
	}
	visibleRows(e) {
		return this.rows();
	}
	...
	scrollRows(e, t) {
		var n = e - this.vDomScrollPosTop, r = e - this.vDomScrollPosBottom, i = this.vDomWindowBuffer * 2, a = this.rows();
	...
	visibleRows(e) {
		var t = this.elementVertical.scrollTop, n = this.elementVertical.clientHeight + t, r = !1, i = 0, a = 0, o = this.rows();
		if (e) i = this.vDomTop, a = this.vDomBottom;
		else for (var s = this.vDomTop; s <= this.vDomBottom; s++) if (o[s]) if (!r) if (t - o[s].getElement().offsetTop >= 0) i = s;
		else if (r = !0, n - o[s].getElement().offsetTop >= 0) a = s;
		else break;
		else if (n - o[s].getElement().offsetTop >= 0) a = s;
		else break;
		return o.slice(i, a + 1);
	}
	_virtualRenderFill(e, t, n) {
		var r = this.tableElement, i = this.elementVertical, a = 0, o = 0, c = 0, l = 0, u = 0, d = 0, f = this.rows(), p = f.length, m = 0, h, g, _ = [], v = 0, y = 0, b = this.table.rowManager.fixedHeight, x = this.elementVertical.clientHeight, S = this.table.options.rowHeight, C = !0;
		if (e = e || 0, n = n || 0, !e) this.clear();
		else {
		...
		if (p && s.elVisible(this.elementVertical)) {
			for (this.vDomTop = e, this.vDomBottom = e - 1, b || this.table.options.maxHeight ? (S && (y = x / S + this.vDomWindowBuffer / S), y = Math.max(this.vDomWindowMinTotalRows, Math.ceil(y))) : y = p; (y == p || o <= x + this.vDomWindowBuffer || v < this.vDomWindowMinTotalRows) && this.vDomBottom < p - 1;) {
				for (_ = [], g = document.createDocumentFragment(), d = 0; d < y && this.vDomBottom < p - 1;) m = this.vDomBottom + 1, h = f[m], this.styleRow(h, m), h.initialize(!1, !0), !h.heightInitialized && !this.table.options.rowHeight && h.clearCellHeight(), g.appendChild(h.getElement()), _.push(h), this.vDomBottom++, d++;
				if (!_.length) break;
				r.appendChild(g), _.forEach((e) => {
					e.rendered();
				});
				let e = [];
				_.forEach((t) => {
					...
					c = e.getHeight(), v < a ? u += c : o += c, c > this.vDomWindowBuffer && (this.vDomWindowBuffer = c * 2), v++;
				}), C = this.table.rowManager.adjustTableSize(), x = this.elementVertical.clientHeight, C && (b || this.table.options.maxHeight) && (S = o / v, y = Math.max(this.vDomWindowMinTotalRows, Math.ceil(x / S + this.vDomWindowBuffer / S)));
			}
	...
	_addTopRow(e, t) {
		for (var n = this.tableElement, r = [], i = 0, a = this.vDomTop - 1, o = 0, s = !0; s;) if (this.vDomTop) {
			let c = e[a], l, u;
			c && o < this.vDomMaxRenderChain ? (l = c.getHeight() || this.vDomRowHeight, u = c.initialized, t >= l ? (this.styleRow(c, a), n.insertBefore(c.getElement(), n.firstChild), (!c.initialized || !c.heightInitialized) && r.push(c), c.initialize(), u || (l = c.getElement().offsetHeight, l > this.vDomWindowBuffer && (this.vDomWindowBuffer = l * 2)), t -= l, i += l, this.vDomTop--, a--, o++) : s = !1) : s = !1;
		} else s = !1;
		for (let e of r) e.clearCellHeight();
	...
	_removeTopRow(e, t) {
		for (var n = [], r = 0, i = 0, a = !0; a;) {
			let o = e[this.vDomTop], s;
			o && i < this.vDomMaxRenderChain ? (s = o.getHeight() || this.vDomRowHeight, t >= s ? (this.vDomTop++, t -= s, r += s, n.push(o), i++) : a = !1) : a = !1;
		}
		for (let e of n) {
			let t = e.getElement();
	...
	_addBottomRow(e, t) {
		for (var n = this.tableElement, r = [], i = 0, a = this.vDomBottom + 1, o = 0, s = !0; s;) {
			let c = e[a], l, u;
			c && o < this.vDomMaxRenderChain ? (l = c.getHeight() || this.vDomRowHeight, u = c.initialized, t >= l ? (this.styleRow(c, a), n.appendChild(c.getElement()), (!c.initialized || !c.heightInitialized) && r.push(c), c.initialize(), u || (l = c.getElement().offsetHeight, l > this.vDomWindowBuffer && (this.vDomWindowBuffer = l * 2)), t -= l, i += l, this.vDomBottom++, a++, o++) : s = !1) : s = !1;
		}
		for (let e of r) e.clearCellHeight();
	...
	_removeBottomRow(e, t) {
		for (var n = [], r = 0, i = 0, a = !0; a;) {
			let o = e[this.vDomBottom], s;
			o && i < this.vDomMaxRenderChain ? (s = o.getHeight() || this.vDomRowHeight, t >= s ? (this.vDomBottom--, t -= s, r += s, n.push(o), i++) : a = !1) : a = !1;
		}
		for (let e of n) {
			let t = e.getElement();
			t.parentNode && t.parentNode.removeChild(t);
	...
	initializePlaceholder() {
		...
		if (typeof e == "function" && (e = e.call(this.table)), e = this.chain("placeholder", [e], e, e) || e, e) {
			...
			if (t.classList.add("tabulator-placeholder"), typeof e == "string") {
				...
				n.classList.add("tabulator-placeholder-contents"), n.innerHTML = e, t.appendChild(n), this.placeholderContents = n;
	...
	initialize() {
		this.initializePlaceholder(), this.initializeRenderer(), this.element.appendChild(this.tableElement), this.firstRender = !0, this.element.addEventListener("scroll", () => {
			var e = this.element.scrollLeft, t = this.scrollLeft > e, n = this.element.scrollTop, r = this.scrollTop > n;
			this.scrollLeft != e && (this.scrollLeft = e, this.dispatch("scroll-horizontal", e, t), this.dispatchExternal("scrollHorizontal", e, t), this._positionPlaceholder()), this.scrollTop != n && (this.scrollTop = n, this.renderer.scrollRows(n, r), this.dispatch("scroll-vertical", n, r), this.dispatchExternal("scrollVertical", n, r));
		});
	}
	findRow(e) {
		if (typeof e == "object") {
			...
			if (typeof HTMLElement < "u" && e instanceof HTMLElement) return this.rows.find((t) => t.getElement() === e) || !1;
			if (e === null) return !1;
		} else if (e === void 0) return !1;
		else return this.rows.find((t) => t.data[this.table.options.index] == e) || !1;
		return !1;
	}
	...
	setData(e, t, n) {
		return new Promise((r, i) => {
			...
			}) : (this.table.options.autoColumns && n && this.table.initialized && this.table.columnManager.generateColumnsFromRowData(e), this.resetScroll(), this._setDataActual(e)), r();
		});
	}
	_setDataActual(e, t) {
	...
	deleteRow(e, t) {
		var n = this.rows.indexOf(e), r = this.activeRows.indexOf(e);
		r > -1 && this.activeRows.splice(r, 1), n > -1 && this.rows.splice(n, 1), this.setActiveRows(this.activeRows), this.displayRowIterator((t) => {
			var n = t.indexOf(e);
			n > -1 && t.splice(n, 1);
	...
	addRows(e, t, n, r) {
		...
		return new Promise((a, o) => {
			t = this.findAddRowPos(t), Array.isArray(e) || (e = [e]), (n === void 0 && t || n !== void 0 && !t) && e.reverse(), e.forEach((e, r) => {
				var a = this.addRow(e, t, n, !0);
				i.push(a), this.dispatch("row-added", a, e, t, n);
			}), this.refreshActiveData(r ? "displayPipeline" : !1, !1, !0), this.regenerateRowPositions(), this.displayRowsCount && this._clearPlaceholder(), a(i);
		});
	}
	findAddRowPos(e) {
		return e === void 0 && (e = this.table.options.addRowPos), e === "pos" && (e = !0), e === "bottom" && (e = !1), e;
	}
	addRowActual(e, t, n, r) {
		var i = e instanceof D ? e : new D(e || {}, this), a = this.findAddRowPos(t), o = -1, s, c;
		return n || (c = this.chain("row-adding-position", [i, a], null, {
			index: n,
			top: a
		}), n = c.index, a = c.top), n !== void 0 && (n = this.findRow(n)), n = this.chain("row-adding-index", [
			i,
			n,
			a
		], null, n), n && (o = this.rows.indexOf(n)), n && o > -1 ? (s = this.activeRows.indexOf(n), this.displayRowIterator(function(e) {
			var t = e.indexOf(n);
	...
	moveRowActual(e, t, n) {
		this.moveRowInArray(this.rows, e, t, n), this.moveRowInArray(this.activeRows, e, t, n), this.displayRowIterator((r) => {
			this.moveRowInArray(r, e, t, n);
		}), this.dispatch("row-moving", e, t, n);
	}
	moveRowInArray(e, t, n, r) {
		var i, a, o, s;
		if (t !== n && (i = e.indexOf(t), i > -1 && (e.splice(i, 1), a = e.indexOf(n), a > -1 ? r ? e.splice(a + 1, 0, t) : e.splice(a, 0, t) : e.splice(i, 0, t)), e === this.getDisplayRows())) {
			...
			for (let t = o; t <= s; t++) e[t] && this.styleRow(e[t], t);
		}
	}
	clearData() {
		this.setData([]);
	...
	nextDisplayRow(e, t) {
		var n = this.getDisplayRowIndex(e), r = !1;
	...
	refreshActiveData(e, t, n) {
		var r = this.table, i = "", a = 0, o = [
			"all",
			"dataPipeline",
			"display",
			"displayPipeline",
		...
		if (!this.table.destroyed) {
			if (typeof e == "function") if (a = this.dataPipeline.findIndex((t) => t.handler === e), a > -1) i = "dataPipeline", t && (a == this.dataPipeline.length - 1 ? i = "display" : a++);
			else if (a = this.displayPipeline.findIndex((t) => t.handler === e), a > -1) i = "displayPipeline", t && (a == this.displayPipeline.length - 1 ? i = "end" : a++);
			else {
	...
	refreshPipelines(e, t, n, r) {
		switch (this.dispatch("data-refreshing"), (!e || !this.activeRowsPipeline[0]) && (this.activeRowsPipeline[0] = this.rows.slice(0)), t) {
			...
			case "display": n = 0, this.resetDisplayRows();
			case "displayPipeline": for (let e = n; e < this.displayPipeline.length; e++) {
				let t = this.displayPipeline[e].handler((e ? this.getDisplayRows(e - 1) : this.activeRows).slice(0), r);
	...
	getRows(e) {
		...
		switch (e) {
			...
			case "visible":
				...
				break;
			default: t = this.chain("rows-retrieve", e, null, this.rows) || this.rows;
		}
		return t;
	}
	...
	initializeRenderer() {
		...
		e = typeof this.table.options.renderVertical == "string" ? t[this.table.options.renderVertical] : this.table.options.renderVertical, e ? (this.renderMode = this.table.options.renderVertical, this.renderer = new e(this.table, this.element, this.tableElement), this.renderer.initialize(), (this.table.element.clientHeight || this.table.options.height) && !(this.table.options.minHeight && this.table.options.maxHeight) ? this.fixedHeight = !0 : this.fixedHeight = !1) : console.error("Unable to find matching renderer:", this.table.options.renderVertical);
	}
	getRenderMode() {
	...
	adjustTableSize() {
		let e = this.element.clientHeight, t, n = !1;
		if (this.renderer.verticalFillMode === "fill") {
			...
			if (this.fixedHeight) {
				...
				let e = "calc(100% - " + r + "px)";
				this.element.style.minHeight = t || "calc(100% - " + r + "px)", this.element.style.height = e, this.element.style.maxHeight = e;
	...
	pseudoMouseLeave(e, t) {
		var n = Object.keys(this.pseudoTrackers), r = {
			row: ["cell"],
			cell: ["row"]
		};
		n = n.filter((t) => {
			...
			var n = this.pseudoTrackers[e].target;
			this.pseudoTrackers[e].target && (this.dispatch(e + "-mouseleave", t, n), this.pseudoTrackers[e].target = null);
		});
	}
	...
	subscriptionChanged(e, t, n) {
		var r = this.listeners[t].components, i = r.indexOf(e), a = !1;
	...
	track(e, t) {
		var n = t.composedPath && t.composedPath() || t.path, r = this.findTargets(n);
	...
	findTargets(e) {
		var t = {};
		let n = Object.keys(this.componentMap);
		for (let r of e) {
			let e = r.classList ? [...r.classList] : [];
			if (e.filter((e) => this.abortClasses.includes(e)).length) break;
			let i = e.filter((e) => n.includes(e));
			for (let e of i) t[this.componentMap[e]] || (t[this.componentMap[e]] = r);
		}
		return t.group && t.group === t.row && delete t.row, t;
	}
	bindComponents(e, t) {
		var n = Object.keys(t).reverse(), r = this.listeners[e], i = {}, a = {}, o = {};
		for (let e of n) {
			let n, a = t[e], s = this.previousTargets[e];
			if (s && s.target === a) n = s.component;
			else switch (e) {
				case "row":
				case "group":
					(r.components.includes("row") || r.components.includes("cell") || r.components.includes("group")) && (n = this.table.rowManager.getVisibleRows(!0).find((e) => e.getElement() === a), t.row && t.row.parentNode && t.row.parentNode.closest(".tabulator-row") && (t[e] = !1));
					break;
				case "column":
					r.components.includes("column") && (n = this.table.columnManager.findColumn(a));
					break;
				case "cell":
		...
		return this.previousTargets = o, Object.keys(t).forEach((e) => {
			a[e] = i[e];
		}), a;
	}
	triggerEvents(e, t, n) {
		var r = this.listeners[e];
		for (let i in n) n[i] && r.components.includes(i) && this.dispatch(i + "-" + e, t, n[i]);
	}
	clearWatchers() {
		for (let e in this.listeners) {
			let t = this.listeners[e];
	...
	handle(e, t, n) {
		if (this.bindings[e] && this.bindings[e][n] && typeof this.bindings[e][n].bind == "function") return this.bindings[e][n].bind(null, t);
		n !== "then" && typeof n == "string" && !n.startsWith("_") && this.table.options.debugInvalidComponentFuncs && console.error("The " + e + " component does not have a " + n + " function, have you checked that you have the correct Tabulator module installed?");
	}
}, pn = class extends o {
	constructor(e) {
	...
	load(e, t, n, r, i, a) {
		...
		return this.table.destroyed ? Promise.resolve() : (this.dispatchExternal("dataLoading", e), e && (e.indexOf("{") == 0 || e.indexOf("[") == 0) && (e = JSON.parse(e)), this.confirm("data-loading", [
			e,
			t,
			n,
			i
		]) ? (this.loading = !0, i || this.alertLoader(), t = this.chain("data-params", [
			e,
			n,
			i
			...
			if (this.table.destroyed) console.warn("Data Load Response Blocked - Table has been destroyed");
				...
				!Array.isArray(e) && typeof e == "object" && (e = this.mapParams(e, this.objectInvert(this.table.options.dataReceiveParams)));
				var t = this.chain("data-loaded", [e], null, e);
				o == this.requestOrder ? (this.clearAlert(), t !== !1 && (this.dispatchExternal("dataLoaded", t), this.table.rowManager.setData(t, r, a === void 0 ? !r : a))) : console.warn("Data Load Response Blocked - An active data load request was blocked by an attempt to change table data while the request was being made");
			}
		}).catch((e) => {
			console.error("Data Load Error: ", e), this.dispatchExternal("dataLoadError", e), i || this.alertError(), setTimeout(() => {
				this.clearAlert();
	...
	mapParams(e, t) {
		var n = {};
		for (let r in e) n[t.hasOwnProperty(r) ? t[r] : r] = e[r];
		return n;
	}
	objectInvert(e) {
		var t = {};
	...
	alertLoader() {
		(typeof this.table.options.dataLoader == "function" ? this.table.options.dataLoader() : this.table.options.dataLoader) && this.table.alertManager.alert(this.table.options.dataLoaderLoading || this.langText("data|loading"));
	}
	alertError() {
	...
	unsubscribe(e, t) {
		var n;
		if (this.events[e]) if (t) if (n = this.events[e].findIndex((e) => e === t), n > -1) this.events[e].splice(n, 1);
		else {
	...
	_dispatch() {
		var e = Array.from(arguments), t = e.shift(), n;
		return this.events[t] && this.events[t].forEach((t, r) => {
			let i = t.apply(this.table, e);
			r || (n = i);
		}), n;
	}
	_debugDispatch() {
	...
	unsubscribe(e, t) {
		var n;
		if (this.events[e]) {
			if (t) if (n = this.events[e].findIndex((e) => e.callback === t), n > -1) this.events[e].splice(n, 1);
			else {
				console.warn("Cannot remove event, no matching event found:", e, t);
				return;
			}
	...
	_chain(e, t, n, r) {
		var i = n;
		return Array.isArray(t) || (t = [t]), this.subscribed(e) ? (this.events[e].forEach((e, n) => {
			i = e.callback.apply(this, t.concat([i]));
		}), i) : typeof r == "function" ? r() : r;
	}
	_confirm(e, t) {
		var n = !1;
		return Array.isArray(t) || (t = [t]), this.subscribed(e) && this.events[e].forEach((e, r) => {
			e.callback.apply(this, t) && (n = !0);
		}), n;
	}
	_notifySubscriptionChange(e, t) {
		var n = this.subscriptionNotifiers[e];
	...
	lookup(e, t, n) {
		if (Array.isArray(e)) {
			for (let n of e) {
				var r = this.lookup(n, t, !0);
				if (r) break;
			}
			if (r) return r;
			this.error(e);
		} else if (t) return this.lookupProp(e, t, n);
		else return this.lookupKey(e, n);
	}
	lookupProp(e, t, n) {
		var r;
...
function bn(e, t) {
	var n = 0, r = this.table.rowManager.element.clientWidth, i = 0, a = !1;
	e.forEach((e, t) => {
		e.widthFixed || e.reinitializeWidth(), (this.table.options.responsiveLayout ? e.modules.responsive.visible : e.visible) && (a = e), e.visible && (n += e.getWidth());
...
function xn(e, t) {
	var n = this.table.rowManager.element.getBoundingClientRect().width, r = 0, i = 0, a = 0, o = 0, s = [], c = [], l = 0, u = 0, d = 0;
	function f(e) {
		return typeof e == "string" ? e.indexOf("%") > -1 ? n / 100 * parseInt(e) : parseInt(e) : e;
	}
	function p(e, t, n, r) {
		var i = [], o = 0, s = 0, c = 0, l = a, u = 0, d = 0, m = [];
		function h(e) {
...
var Sn = {
	...
	layout(t) {
		var n = this.table.columnManager.columnsByIndex.find((e) => e.definition.variableHeight || e.definition.formatter === "textarea");
...
i(Cn, "moduleName", "layout"), i(Cn, "modes", Sn);
var wn = { default: {
	groups: {
		item: "item",
		items: "items"
	...
	initialize() {
		this.langList = s.deepClone(e.langs), this.table.options.columnDefaults.headerFilterPlaceholder !== !1 && this.setHeaderFilterPlaceholder(this.table.options.columnDefaults.headerFilterPlaceholder);
	...
	_setLangProp(e, t) {
		for (let n in t) e[n] && typeof e[n] == "object" ? this._setLangProp(e[n], t[n]) : e[n] = t[n];
	}
	setLocale(e) {
		e = e || "default";
		function t(e, n) {
			for (var r in e) typeof e[r] == "object" ? (n[r] || (n[r] = {}), t(e[r], n[r])) : n[r] = e[r];
		}
		...
		this.locale = e, this.lang = s.deepClone(this.langList.default || {}), e != "default" && t(this.langList[e], this.lang), this.dispatchExternal("localized", this.locale, this.lang), this._executeBindings();
	}
	getLocale(e) {
		return this.locale;
	}
...
i(Tn, "moduleName", "localize"), i(Tn, "langs", wn);
var En = class extends l {
	...
	send(e, t, n, r) {
		...
		i.forEach((e) => {
			e.tableComms(this.table.element, t, n, r);
...
a = On, i(On, "registry", {
	tables: [],
	register(e) {
		a.registry.tables.push(e);
	},
	deregister(e) {
		var t = a.registry.tables.indexOf(e);
		t > -1 && a.registry.tables.splice(t, 1);
	},
	lookupTable(e, t) {
		var n = [], r, i;
		if (typeof e == "string") {
			if (r = document.querySelectorAll(e), r.length) for (var o = 0; o < r.length; o++) i = a.registry.matchElement(r[o]), i && n.push(i);
		} else typeof HTMLElement < "u" && e instanceof HTMLElement || e instanceof a ? (i = a.registry.matchElement(e), i && n.push(i)) : Array.isArray(e) ? e.forEach(function(e) {
			n = n.concat(a.registry.lookupTable(e));
		}) : t || console.warn("Table Connection Error - Invalid Selector", e);
		return n;
	},
	matchElement(e) {
		return a.registry.tables.find(function(t) {
			return e instanceof a ? t === e : t.element === e;
		});
	}
});
var Z = class e extends On {
	constructor() {
		super();
	}
	static initializeModuleBinder(t) {
		e.modulesRegistered || (e.modulesRegistered = !0, e._registerModules(Dn, !0), t && e._registerModules(t));
	}
	static _extendModule(t, n, r) {
		if (e.moduleBindings[t]) {
			var i = e.moduleBindings[t][n];
			if (i) if (typeof r == "object") for (let e in r) i[e] = r[e];
	...
	static _registerModuleExtensions(t) {
		...
		if (t.moduleExtensions) for (let t in n) {
			let r = n[t];
			if (e.moduleBindings[t]) for (let n in r) e._extendModule(t, n, r[n]);
			else {
				e.moduleExtensions[t] || (e.moduleExtensions[t] = {});
				for (let n in r) e.moduleExtensions[t][n] || (e.moduleExtensions[t][n] = {}), Object.assign(e.moduleExtensions[t][n], r[n]);
			}
		}
	...
	static _extendModuleFromQueue(t) {
		...
		if (n) for (let r in n) e._extendModule(t.moduleName, r, n[r]);
	}
	_bindModules() {
		var t = [], n = [], r = [];
		for (var i in this.modules = {}, e.moduleBindings) {
			let a = e.moduleBindings[i], o = new a(this);
			this.modules[i] = o, a.prototype.moduleCore ? this.modulesCore.push(o) : a.moduleInitOrder ? a.moduleInitOrder < 0 ? t.push(o) : n.push(o) : r.push(o);
		}
		t.sort((e, t) => e.moduleInitOrder > t.moduleInitOrder ? 1 : -1), n.sort((e, t) => e.moduleInitOrder > t.moduleInitOrder ? 1 : -1), this.modulesRegular = t.concat(r.concat(n));
	}
};
i(Z, "moduleBindings", {}), i(Z, "moduleExtensions", {}), i(Z, "modulesRegistered", !1), i(Z, "defaultModules", !1);
var kn = class extends o {
	...
	static extendModule() {
		e.initializeModuleBinder(), e._extendModule(...arguments);
	}
	static registerModule() {
		e.initializeModuleBinder(), e._registerModule(...arguments);
	}
	constructor(t, n, r) {
		super(), e.initializeModuleBinder(r), this.options = {}, this.columnManager = null, this.rowManager = null, this.footerManager = null, this.alertManager = null, this.vdomHoz = null, this.externalEvents = null, this.eventBus = null, this.interactionMonitor = !1, this.browser = "", this.browserSlow = !1, this.browserMobile = !1, this.rtl = !1, this.originalElement = null, this.componentFunctionBinder = new fn(this), this.dataLoader = !1, this.modules = {}, this.modulesCore = [], this.modulesRegular = [], this.deprecationAdvisor = new gn(this), this.optionsList = new nn(this, "table constructor"), this.dependencyRegistry = new _n(this), this.initialized = !1, this.destroyed = !1, this.initializeElement(t) && (this.initializeCoreSystems(n), setTimeout(() => {
			this._create();
	...
	initializeCoreSystems(t) {
		this.columnManager = new on(this), this.rowManager = new ln(this), this.footerManager = new un(this), this.dataLoader = new pn(this), this.alertManager = new kn(this), this._bindModules(), this.options = this.optionsList.generate(e.defaultOptions, t), this._clearObjectPointers(), this._mapDeprecatedFunctionality(), this.externalEvents = new mn(this, this.options, this.options.debugEventsExternal), this.eventBus = new hn(this.options.debugEventsInternal), this.interactionMonitor = new dn(this), this.dataLoader.initialize(), this.footerManager.initialize(), this.dependencyRegistry.initialize();
	}
	...
	_rtlCheck() {
		...
		switch (this.options.textDirection) {
			case "auto": if (e.direction !== "rtl") break;
			case "rtl":
	...
	_buildElement() {
		var e = this.element, t = this.options, n;
		if (e.tagName === "TABLE") {
			this.originalElement = this.element, n = document.createElement("div");
			var r = e.attributes;
			for (var i in r) typeof r[i] == "object" && n.setAttribute(r[i].name, r[i].value);
			e.parentNode.replaceChild(n, e), this.element = e = n;
		}
	...
	initGuard(e, t) {
		var n, r;
		return this.options.debugInitialization && !this.initialized && (e || (n = (/* @__PURE__ */ Error()).stack.split("\n"), r = n[0] == "Error" ? n[2] : n[1], e = r[0] == " " ? r.trim().split(" ")[1].split(".")[1] : r.trim().split("@")[0]), console.warn("Table Not Initialized - Calling the " + e + " function before the table is initialized may result in inconsistent behavior, Please wait for the `tableBuilt` event before calling this function." + (t ? " " + t : ""))), this.initialized;
	}
	blockRedraw() {
	...
	setData(e, t, n) {
		return this.initGuard(!1, "To set initial data please use the 'data' property in the table constructor."), this.dataLoader.load(e, t, n, !1);
	}
	clearData() {
	...
	replaceData(e, t, n) {
		return this.initGuard(), this.dataLoader.load(e, t, n, !0, !0);
	}
	updateData(e) {
		var t = 0;
		return this.initGuard(), new Promise((n, r) => {
			this.dataLoader.blockActiveLoad(), typeof e == "string" && (e = JSON.parse(e)), e && e.length > 0 ? e.forEach((e) => {
				var i = this.rowManager.findRow(e[this.options.index]);
				i ? (t++, i.updateData(e).then(() => {
					t--, t || n();
				}).catch((t) => {
					r("Update Error - Unable to update row", e, t);
				})) : r("Update Error - Unable to find row", e);
			}) : (console.warn("Update Error - No data provided"), r("Update Error - No data provided"));
		});
	}
	addData(e, t, n) {
		return this.initGuard(), new Promise((r, i) => {
			this.dataLoader.blockActiveLoad(), typeof e == "string" && (e = JSON.parse(e)), e ? this.rowManager.addRows(e, t, n).then((e) => {
				var t = [];
				e.forEach(function(e) {
					t.push(e.getComponent());
				}), r(t);
	...
	deleteRow(e) {
		...
		for (let n of e) {
			let e = this.rowManager.findRow(n, !0);
			if (e) t.push(e);
			else return console.error("Delete Error - No matching row found:", n), Promise.reject("Delete Error - No matching row found");
		}
	...
	addRow(e, t, n) {
		return this.initGuard(), typeof e == "string" && (e = JSON.parse(e)), this.rowManager.addRows(e, t, n, !0).then((e) => e[0].getComponent());
	}
	updateOrAddRow(e, t) {
		var n = this.rowManager.findRow(e);
		return this.initGuard(), typeof t == "string" && (t = JSON.parse(t)), n ? n.updateData(t).then(() => n.getComponent()) : this.rowManager.addRows(t).then((e) => e[0].getComponent());
	}
	updateRow(e, t) {
		var n = this.rowManager.findRow(e);
		return this.initGuard(), typeof t == "string" && (t = JSON.parse(t)), n ? n.updateData(t).then(() => Promise.resolve(n.getComponent())) : (console.warn("Update Error - No matching row found:", e), Promise.reject("Update Error - No matching row found"));
	}
	scrollToRow(e, t, n) {
		var r = this.rowManager.findRow(e);
		return r ? this.rowManager.scrollToRow(r, t, n) : (console.warn("Scroll Error - No matching row found:", e), Promise.reject("Scroll Error - No matching row found"));
	}
	moveRow(e, t, n) {
		var r = this.rowManager.findRow(e);
		this.initGuard(), r ? r.moveToRow(t, n) : console.warn("Move Error - No matching row found:", e);
	}
	getRows(e) {
	...
	showColumn(e) {
		var t = this.columnManager.findColumn(e);
		if (this.initGuard(), t) t.show();
		else return console.warn("Column Show Error - No matching column found:", e), !1;
	}
	hideColumn(e) {
		var t = this.columnManager.findColumn(e);
		if (this.initGuard(), t) t.hide();
		else return console.warn("Column Hide Error - No matching column found:", e), !1;
	}
	toggleColumn(e) {
		var t = this.columnManager.findColumn(e);
		if (this.initGuard(), t) t.visible ? t.hide() : t.show();
		else return console.warn("Column Visibility Toggle Error - No matching column found:", e), !1;
	}
	addColumn(e, t, n) {
		var r = this.columnManager.findColumn(n);
		return this.initGuard(), this.columnManager.addColumn(e, t, r).then((e) => e.getComponent());
	}
	deleteColumn(e) {
		var t = this.columnManager.findColumn(e);
	...
	updateColumnDefinition(e, t) {
		...
		return this.initGuard(), n ? n.updateDefinition(t) : (console.warn("Column Update Error - No matching column found:", e), Promise.reject());
	}
	moveColumn(e, t, n) {
		var r = this.columnManager.findColumn(e), i = this.columnManager.findColumn(t);
		this.initGuard(), r ? i ? this.columnManager.moveColumn(r, i, n) : console.warn("Move Error - No matching column found:", i) : console.warn("Move Error - No matching column found:", e);
	}
	scrollToColumn(e, t, n) {
		return new Promise((r, i) => {
			var a = this.columnManager.findColumn(e);
			return a ? this.columnManager.scrollToColumn(a, t, n) : (console.warn("Scroll Error - No matching column found:", e), Promise.reject("Scroll Error - No matching column found"));
		});
	}
	redraw(e) {
...
i(Q, "defaultOptions", tn);
var An = class extends Q {
	static extendModule() {
		Q.initializeModuleBinder(Y), Q._extendModule(...arguments);
	}
	static registerModule() {
		Q.initializeModuleBinder(Y), Q._registerModule(...arguments);
	}
	constructor(e, t, n) {
		super(e, t, Y);
	}
	...
	checkValidity(e, t, n, r, i) {
		let a = jn.prototype.checkValidity.call(this, e, t, n, r, i), o = this.getValue(), s = this.getComponentValidationMessage(o);
		return this.setCustomValidity && this.setCustomValidity(s || "", t), i || (s ? this.showError(s) : this.hideError()), a && !s;
	}
	getComponentValidationMessage(e) {
		let t = !!(this.component.validate && this.component.validate.required), n = this.getEnteredRowsFromValue(e), r = n.some((e) => this.isCompleteRowArray(e)), i = n.some((e) => this.isPartiallyFilledRowArray(e));
	...
	isPartiallyFilledRowArray(e) {
		let t = e.some((e) => String(e || "").trim() !== ""), n = e.some((e) => String(e || "").trim() === "");
		return t && n;
	}
	createBlankRow(e) {
		let t = {};
	...
	setStoredValue(e, t) {
		this._tableValue = e, this.dataValue = e, t && this.triggerChange();
	}
...
//#endregion
export { $ as PasteTableComponent, $ as default };
